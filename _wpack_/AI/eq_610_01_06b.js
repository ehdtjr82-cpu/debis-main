/*amd /AI/eq_610_01_06b.xml 38496 e4b300273b404abe2dc176fc481e24515a6ada8e69493d5adbc2c0023c87a662 */
define({declaration:{A:{version:'1.0',encoding:'UTF-8'}},E:[{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',E:[{T:1,N:'w2:type',E:[{T:3,text:'COMPONENT'}]},{T:1,N:'xf:model',E:[{T:1,N:'w2:dataCollection',A:{baseNode:'map'},E:[{T:1,N:'w2:dataMap',A:{baseNode:'map',id:'ds_search'},E:[{T:1,N:'w2:keyInfo',E:[{T:1,N:'w2:key',A:{id:'oilBizClsCd',name:'유류사업구분코드',dataType:'text'}},{T:1,N:'w2:key',A:{id:'selpchClsCd',name:'매출입구분코드',dataType:'text'}},{T:1,N:'w2:key',A:{id:'oilUprrglClsCd',name:'유류단가유형코드',dataType:'text'}},{T:1,N:'w2:key',A:{id:'stdDt',name:'기준일자',dataType:'text'}},{T:1,N:'w2:key',A:{id:'oilTskClsCd',name:'유류사업구분코드',dataType:'text'}},{T:1,N:'w2:key',A:{id:'endDt',name:'종료일자',dataType:'text'}},{T:1,N:'w2:key',A:{id:'clntNo',name:'거래처번호',dataType:'text'}},{T:1,N:'w2:key',A:{id:'dcsnSts',name:'확정상태',dataType:'text'}}]}]},{T:1,N:'w2:dataList',A:{baseNode:'list',repeatNode:'map',id:'ds_oilUnitPrice',saveRemovedData:'true'},E:[{T:1,N:'w2:columnInfo',E:[{T:1,N:'w2:column',A:{id:'selYn',name:'선택',dataType:'text'}},{T:1,N:'w2:column',A:{id:'oilTskClsCd',name:'유류업무구분',dataType:'text'}},{T:1,N:'w2:column',A:{id:'oilBizClsCd',name:'유류사업구분코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'selpchClsCd',name:'매출입구분코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'clntNo',name:'거래처코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'clntNm',name:'거래처이름',dataType:'text'}},{T:1,N:'w2:column',A:{id:'oilUprrglClsCd',name:'유류단가정상구분코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'oilkndCd',name:'유종코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'stdDt',name:'기준일자',dataType:'text'}},{T:1,N:'w2:column',A:{id:'endDt',name:'종료일자',dataType:'text'}},{T:1,N:'w2:column',A:{id:'uprGasoline',name:'휘발유단가',dataType:'text'}},{T:1,N:'w2:column',A:{id:'uprLight',name:'경유단가',dataType:'text'}},{T:1,N:'w2:column',A:{id:'uprLpg',name:'LPG단가',dataType:'text'}},{T:1,N:'w2:column',A:{id:'bilgAcctDeptCd',name:'청구귀속부서코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'bilgAcctDeptNm',name:'청구귀속부서이름',dataType:'text'}},{T:1,N:'w2:column',A:{id:'sellAcctDeptCd',name:'매출귀속부서코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'sellAcctDeptNm',name:'매출귀속부서이름',dataType:'text'}},{T:1,N:'w2:column',A:{id:'qty',name:'수량',dataType:'text'}},{T:1,N:'w2:column',A:{id:'fixEndDt',name:'거래종료일자',dataType:'text'}},{T:1,N:'w2:column',A:{id:'confYn',name:'확정여부',dataType:'text'}},{T:1,N:'w2:column',A:{id:'apprvStsCd',name:'결재상태코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'oilSellClsCd',name:'유류판매구분코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'sellClntNo',name:'매출거래처번호',dataType:'text'}}]}]}]},{T:1,N:'w2:workflowCollection'},{T:1,N:'xf:submission',A:{id:'sbm_retrieve',action:'/ps.eq.fmsmgnt.fmsoilmgnt.RetrieveFmsOilUnitPriceCMD.do',method:'post',mediatype:'application/json',mode:'asynchronous',encoding:'UTF-8',ref:'data:json,[{"id":"ds_search","key":"IN_DS1"},{"id":"ds_oilUnitPrice","key":"OUT_DS1"}]',target:'data:json,[{"id":"ds_oilUnitPrice","key":"OUT_DS1"}]','ev:submitdone':'scwin.sbm_retrieve_submitdone','ev:submiterror':'scwin.sbm_retrieve_submiterror'}},{T:1,N:'xf:submission',A:{id:'sbm_saveOilPrice',action:'/ps.eq.fmsmgnt.fmsoilmgnt.RegistFmsOilUnitPriceCMD.do',method:'post',mediatype:'application/json',mode:'asynchronous',encoding:'UTF-8',ref:'data:json,[{"id":"ds_oilUnitPrice","key":"IN_DS1"}]',target:'data:json,[]','ev:submitdone':'scwin.sbm_saveOilPrice_submitdone','ev:submiterror':'scwin.sbm_saveOilPrice_submiterror'}},{T:1,N:'xf:submission',A:{id:'sbm_confirmOilPrice',action:'/ps.eq.fmsmgnt.fmsoilmgnt.ConfirmFmsOilUnitPriceCMD.do',method:'post',mediatype:'application/json',mode:'asynchronous',encoding:'UTF-8',ref:'data:json,[{"id":"ds_oilUnitPrice","key":"IN_DS1"}]',target:'data:json,[]','ev:submitdone':'scwin.sbm_confirmOilPrice_submitdone','ev:submiterror':'scwin.sbm_confirmOilPrice_submiterror'}},{T:1,N:'xf:submission',A:{id:'sbm_fixEndDt',action:'/ps.eq.fmsmgnt.fmsoilmgnt.UpdateFixEndDtCMD.do',method:'post',mediatype:'application/json',mode:'asynchronous',encoding:'UTF-8',ref:'data:json,[{"id":"ds_oilUnitPrice","key":"IN_DS1"}]',target:'data:json,[]','ev:submitdone':'scwin.sbm_fixEndDt_submitdone','ev:submiterror':'scwin.sbm_fixEndDt_submiterror'}}]},{T:1,N:'w2:layoutInfo'},{T:1,N:'w2:publicInfo',A:{method:''}},{T:1,N:'script',A:{type:'text/javascript'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){scwin.deptCd = "00276";
scwin.vCurDate = "";
scwin.empNo = "";
scwin.epId = "";
scwin.userId = "";
scwin.onpageload = async function () {
  ...
  ds_search.set("oilUprrglClsCd", "03");
  let codeOptions = [{
    grpCd: "TL103",
  ...
  acb_dcsnSts.setSelectedIndex(0);
  btn_confirmC.setVisible(false);
  btn_confirmD.setVisible(false);
};
scwin.onUdcCompleted = async function () {
  let stdDt = scwin.vCurDate.substring(0, 6) + "01";
  udc_Dt.setInitDate(stdDt, scwin.vCurDate);
  scwin.f_Retrieve();
  ica_stdDt.setFocus();
};
...
scwin.btn_confirmC_onclick = async function (e) {
  scwin.f_Confirm("1");
};
scwin.btn_confirmD_onclick = async function (e) {
  scwin.f_Confirm("0");
};
scwin.btn_elecApprv_onclick = async function (e) {
  scwin.f_RequestElectronicApprove();
};
scwin.btn_fixEndDt_onclick = async function (e) {
  scwin.f_fixEndDt();
};
...
scwin.sbm_retrieve_submitdone = async function (e) {
  $c.gus.cfShowTotalRows($p, spa_totalRow, ds_oilUnitPrice.getRowCount());
...
scwin.f_Save = async function () {
  if (ds_oilUnitPrice.getUpdatedIndex().length == 0) {
    await $c.gus.cfAlertMsg($p, MSG_CM_ERR_001, ["유류자가운송할인단가 그리드"]);
    return;
  }
...
scwin.sbm_saveOilPrice_submiterror = async function (e) {
  $c.gus.cfShowError($p, e);
};
...
scwin.f_AddRow = async function () {
  let chkResult = await scwin.f_Check();
  if (!chkResult) {
    return;
  }
  ...
  ds_oilUnitPrice.setCellData(newIdx, "oilUprrglClsCd", "03");
  if (newIdx > 0) {
  ...
  spa_totalRow.setValue(ds_oilUnitPrice.getTotalRow());
};
...
scwin.sbm_confirmOilPrice_submiterror = async function (e) {
  $c.gus.cfShowError($p, e);
};
scwin.f_RequestElectronicApprove = async function () {
  ...
  let chk = await $c.win.confirm($p, "전자결재 요청하시겠습니까?");
  if (!chk) {
    return;
  }
  let vReqApprvTitle = "FMS 유류자가운송할인단가  승인요청_" + toDay;
  ...
  // TODO: frmReqApprove.submit() → WebSquare 전자결재 연동 방식으로 대체 필요
  $c.gus.cfRequestApprove($p, approveData);
};
...
scwin.f_fixEndDt = async function () {
  let chkValid = await $c.gus.cfValidate($p, [ica_fixEndDt]);
  if (!chkValid) return;
  if (!scwin.f_checkflag()) {
    await $c.gus.cfAlertMsg($p, MSG_CM_ERR_056, ["항목"]);
    return;
  ...
  let cnt = 0;
  let chk = await $c.win.confirm($p, "거래를 종료하시겠습니까?");
  if (chk) {
    for (let i = 0; i < ds_oilUnitPrice.getRowCount(); i++) {
      if (ds_oilUnitPrice.getCellData(i, "selYn") == "T") {
        if (ds_oilUnitPrice.getCellData(i, "endDt") != "99999999") {
          ...
          return;
        } else if (!$c.gus.cfIsAfterDate($p, ds_oilUnitPrice.getCellData(i, "stdDt"), ica_fixEndDt.getValue(), false)) {
          await $c.gus.cfAlertMsg($p, "종료일자는 기준일자보다 이후이어야 합니다.");
          ica_fixEndDt.setFocus();
          return;
        }
        ds_oilUnitPrice.setCellData(i, "fixEndDt", ica_fixEndDt.getValue());
        cnt++;
      }
    }
    if (cnt > 0) {
...
scwin.f_setqrynm = function (tname, str) {
  ...
  gr_oilUnitPrice.SetExcelTitle(1, "value:" + tname + " [" + str + "]" + vSearchOption);
};
...
scwin.gr_oilUnitPrice_onrowindexchange = function (rowIndex, oldRowIndex) {
  ...
  if (rowStatus == "R" || rowStatus == "D") {
    gr_oilUnitPrice.setCellReadOnly(rowIndex, "stdDt", true);
    gr_oilUnitPrice.setCellReadOnly(rowIndex, "clntNo", true);
    gr_oilUnitPrice.setCellReadOnly(rowIndex, "uprLight", true);
    gr_oilUnitPrice.setCellReadOnly(rowIndex, "uprGasoline", true);
    gr_oilUnitPrice.setCellReadOnly(rowIndex, "uprLpg", true);
  } else if (rowStatus == "C") {
    gr_oilUnitPrice.setCellReadOnly(rowIndex, "stdDt", false);
    gr_oilUnitPrice.setCellReadOnly(rowIndex, "clntNo", false);
    gr_oilUnitPrice.setCellReadOnly(rowIndex, "uprLight", false);
    gr_oilUnitPrice.setCellReadOnly(rowIndex, "uprGasoline", false);
    gr_oilUnitPrice.setCellReadOnly(rowIndex, "uprLpg", false);
  }
