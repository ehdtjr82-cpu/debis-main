/*amd /cm/udc/fromToCalendarTime.xml 15805 e9fd0e54df7bdd1a96b0ad14ab1fee7c40c1c420bd641f107112b39cfb1fa955 */
...
scwin.cal_fr_ondateselect = function (dateStr, dateObj) {
  ...
  if (dateStr > ipt_to.getValue() && ipt_to.getValue() != "" && dateStr.length == 12) {
    ...
    if (!$c.date.isDate($p, dateStr) && dateStr.length == 12 || parseInt(strY) < minY || parseInt(strY) > maxY) {
...
scwin.onBlurTo = function (e) {
  ...
  if (dateStr != "" && dateStr.length != 12 || !$c.date.isDate($p, dateStr) && dateStr.length == 12) {
    $c.win.alert($p, "날짜 형식이 올바르지 않습니다.", function () {
      ipt_to.setValue("");
      ipt_to.focus();
      return;
...
}}}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload()'},E:[{T:1,N:'xf:group',A:{id:'grp_udcContent',class:'cal-wrap'},E:[{T:1,N:'xf:group',A:{localeRef:'cal-box',id:'grp_group1',class:'cal-input'},E:[{T:1,N:'xf:input',A:{ref:'',rightAlign:'false',dataType:'date',adjustMaxLength:'false',style:'',id:'ipt_from',renderType:'',class:'form-control',title:'시작일자',invalidMessage:'시작일자',allowChar:'0-9','ev:onblur':'scwin.ipt_from_onblur',maxlength:'12',displayFormat:'yyyy/MM/dd HHmm',ioFormat:'yyyyMMddHHmm',validateOnInput:'true','ev:onfocus':'scwin.ipt_from_onfocus'}},{T:1,N:'w2:span',A:{style:'',id:'',label:'~'}},{T:1,N:'xf:input',A:{rightAlign:'false',dataType:'date',displayFormat:'yyyy/MM/dd HHmm',adjustMaxLength:'false',style:'',id:'ipt_to',renderType:'',class:'form-control',ioFormat:'yyyyMMddHHmm',title:'종료일자',invalidMessage:'종료일자',allowChar:'0-9',validateOnInput:'true','ev:onblur':'scwin.onBlurTo',maxlength:'12','ev:onfocus':'scwin.ipt_to_onfocus'}},{T:1,N:'xf:trigger',A:{anchorWithGroupClass:'','ev:onclick':'scwin.img_Cal_onclick',style:'',id:'img_Cal',type:'button',class:'btn ico btn_calender'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'calendar'}]}]}]},{T:1,N:'xf:group',A:{style:'z-index:2000;display:none',id:'gr_cal',class:'gr_cal calender-wrap'},E:[{T:1,N:'xf:group',A:{adaptiveThreshold:'',class:'cal-grp',id:'',style:''},E:[{T:1,N:'w2:calendar',A:{footerDiv:'true',style:'',id:'cal_fr',calendarValueType:'yearMonthDateTime','ev:onconfirm':'','ev:oncancel':'scwin.cal_fr_oncancel'}}]},{T:1,N:'xf:group',A:{class:'cal-grp',id:'',style:''},E:[{T:1,N:'w2:calendar',A:{footerDiv:'true',style:'',id:'cal_to',calendarValueType:'yearMonthDateTime','ev:onconfirm':'','ev:oncancel':'scwin.cal_fr_oncancel'}}]},{T:1,N:'xf:trigger',A:{class:'btn pt-blue',id:'btn_trigger1',style:'',type:'button','ev:onclick':'scwin.btn_trigger1_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'확인'}]}]}]}]}]}]}]})