...
scwin.lpad = function ($p, str, length, char) {
  ...
  if (char == null || typeof char === "undefinded") {
    char = "0";
  }
 ...
 * @hidden N
 * @exception
 * @example $c.str.ltrim(" aa");
 */
scwin.ltrim = function ($p, a) {
  var i;
  i = 0;
 ...
 * @method
 * @name rtrim
 * @description 오른쪽 공백제거
 * @param {string} a desc
 * @returns
 * @hidden N
 * @exception
 * @example  $c.str.rtrim(" aa ");
 */
scwin.rtrim = function ($p, a) {
  var i = a.length - 1;
