...
scwin.strSerialize = function (_$p, object) {
  if (typeof object == 'string') {
    return object;
  } else if ($c.util.isJSON($p, _$p, object)) {
    return JSON.stringify(_$p, object);
  } else if ($c.util.isXmlDoc($p, _$p, object)) {
