/*amd /cm/global_common_component/commonUtil.xml 20047 64143930fbfcce1ad17ca7f209ed929076492df9801af069662e1a089978e717 */
define({declaration:{A:{version:'1.0',encoding:'UTF-8'}},E:[{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',A:{},E:[{T:1,N:'w2:type',E:[{T:3,text:'COMPONENT'}]},{T:1,N:'w2:buildDate'},{T:1,N:'w2:MSA'},{T:1,N:'xf:model',E:[{T:1,N:'w2:dataCollection',A:{baseNode:'map'}},{T:1,N:'w2:workflowCollection'}]},{T:1,N:'w2:layoutInfo'},{T:1,N:'w2:publicInfo',A:{method:'scwin.getJSON,scwin.isJSON,scwin.isArray, scwin.isEmpty,scwin.getObjectType,                                scwin.isMobile,scwin.isXmlDoc,scwin.setGridViewDelCheckBox,scwin.getChildren,scwin.getGridViewDataList,                                scwin.getComponent,scwin.createComponent,scwin.setInterval,scwin.clearInterval,scwin.clearTimeout,                                scwin.copyClipboard,scwin.getFunctionByName,scwin.isMobile,scwin.isEmpty,scwin.getComponent,scwin.setTimeout,scwin.clearTimeout,                                scwin.getLanguage'}},{T:1,N:'script',A:{lazy:'false',type:'text/javascript'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){/**
 * @method
 * @name getJSON
