/*amd /cm/global_common_component/commonMenu.xml 11516 670347dea027eb56f2dd92e760c3cf070649b945b398bd8458a0ba7bc14f3e86 */
define({declaration:{A:{version:'1.0',encoding:'UTF-8'}},E:[{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',E:[{T:1,N:'w2:type',E:[{T:3,text:'COMPONENT'}]},{T:1,N:'w2:buildDate'},{T:1,N:'w2:publicInfo',A:{method:'scwin.initCommonMenu,scwin.getHeaderType,scwin.setHeaderType,                          scwin.openMenu,scwin.getSideType,scwin.setSideType,           scwin.setLayoutType,  scwin.getLayoutType, scwin.setLayoutId,            scwin.getMenuInfo,scwin.setMenuInfo,scwin.getMenuDataList'}},{T:1,N:'xf:model',E:[{T:1,N:'w2:dataCollection',A:{baseNode:'map'}},{T:1,N:'w2:workflowCollection'},{T:1,N:'xf:submission',A:{id:'sbm_menuData',ref:'',target:'data:json,dataList1',action:'',method:'post',mediatype:'application/json',encoding:'UTF-8',instance:'',replace:'',errorHandler:'',customHandler:'',mode:'asynchronous',processMsg:'','ev:submit':'','ev:submitdone':'scwin.sbm_menuData_submitdone','ev:submiterror':'',abortTrigger:''}}]},{T:1,N:'w2:layoutInfo'},{T:1,N:'script',A:{type:'text/javascript',lazy:'false'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){//메뉴관련 array
scwin.menuCallBackArr = [];
// 메뉴 관련 변수 셋팅 START
scwin.COMMON_MENU_INFO = {
  DATA_LIST: "dlt_menu",
  //시스템 오픈시 권한에 따른 전체 메뉴를 관리하는 DATA LIST
...
scwin.MENU_COMPONENT_TYPE = {
  SIDE: "2",
  // WFRAME일 경우 '1', UDC일 경우 '2' , 메인 LAYOUT과 하나의 페이지로 구성되어 있을 경우 '3'
