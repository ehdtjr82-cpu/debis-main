 ...
 * 테스트데이터 :
 *    1. 결산년월[2025/01], 장부구분[804], 부서[00000], 하위부서포함[체크]
 * 수정이력 :
 *    - 2025-12-31      배기원    최초작성
 */
scwin.memJson;
scwin.userId = ""; //사용하지 않음
...
scwin.onpageload = function () {
  ...
  scwin.userId = $c.gus.cfIsNull($p, scwin.memJson["userId"]) ? "" : scwin.memJson["userId"];
 ...
 * 엑셀클릭 시
 */
scwin.f_Retrieve2_old = async function () {
  ...
  for (let i = 0; i < ds_dept.getRowCount(); i++) {
    ...
    for (let x = 0; x < dataList.getRowCount(); x++) {
      ...
      if (mgntAcctCd == "4100000" || mgntAcctCd == "4900000" || mgntAcctCd == "6700000") {
        ...
        //let requestAmt = Number(yearPlanAmt) === 0 ? 0 :  $c.num.round((Number(sumRsltsAmt) / Number(yearPlanAmt)) * 1000) / 10;             
        let requestAmt = Number(yearPlanAmt) === 0 ? 0 : (Number(sumRsltsAmt) / Number(yearPlanAmt) * 100).toFixed(1);
        dataList.setCellData(x, "requestAmt", requestAmt);
      }
    }
...
scwin.f_Export = async function () {
  ...
  //     let exportFileName = "손익자료(전월+당월 평균)_" + ed_bizDomNm.getValue() + "_" + ed_acctDeptNm.getValue() + "_" + ica_closeYm.getValue().trim();
  //     $c.data.downloadGridViewExcel(objGridName, "손익자료(전월+당월 평균)", exportFileName, 2 + 8 + 16);
  // }
...
scwin.f_Export2 = function (acctDeptCd) {
  ...
  // fileName = "C:\\Debis_EIS\\손익자료(전월+당월 평균)_"
...
scwin.f_Rate = function () {
  ...
  for (let i = 0; i < ds_master.getRowCount(); i++) {
    ...
    if (ds_master.getCellData(i, "mgntAcctCd") == "4100000") {
      sellAmt1 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "yearPlanAmt")) ? 0 : ds_master.getCellData(i, "yearPlanAmt"));
      sellAmt2 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "bfyyThisAmt")) ? 0 : ds_master.getCellData(i, "bfyyThisAmt"));
      sellAmt3 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisPlanAmt")) ? 0 : ds_master.getCellData(i, "thisPlanAmt"));
      sellAmt4 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisRsltsAmt")) ? 0 : ds_master.getCellData(i, "thisRsltsAmt"));
      sellAmt5 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisDiffer")) ? 0 : ds_master.getCellData(i, "thisDiffer"));
      sellAmt6 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumBfyyThisAmt")) ? 0 : ds_master.getCellData(i, "sumBfyyThisAmt"));
      sellAmt7 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumPlanAmt")) ? 0 : ds_master.getCellData(i, "sumPlanAmt"));
      sellAmt8 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumRsltsAmt")) ? 0 : ds_master.getCellData(i, "sumRsltsAmt"));
      sellAmt9 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumDiffer")) ? 0 : ds_master.getCellData(i, "sumDiffer"));
    }

    // 매출원가
    if (ds_master.getCellData(i, "mgntAcctCd") == "4200000") {
      sellCost1 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "yearPlanAmt")) ? 0 : ds_master.getCellData(i, "yearPlanAmt"));
      sellCost2 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "bfyyThisAmt")) ? 0 : ds_master.getCellData(i, "bfyyThisAmt"));
      sellCost3 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisPlanAmt")) ? 0 : ds_master.getCellData(i, "thisPlanAmt"));
      sellCost4 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisRsltsAmt")) ? 0 : ds_master.getCellData(i, "thisRsltsAmt"));
      sellCost5 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisDiffer")) ? 0 : ds_master.getCellData(i, "thisDiffer"));
      sellCost6 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumBfyyThisAmt")) ? 0 : ds_master.getCellData(i, "sumBfyyThisAmt"));
      sellCost7 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumPlanAmt")) ? 0 : ds_master.getCellData(i, "sumPlanAmt"));
      sellCost8 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumRsltsAmt")) ? 0 : ds_master.getCellData(i, "sumRsltsAmt"));
      sellCost9 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumDiffer")) ? 0 : ds_master.getCellData(i, "sumDiffer"));
    }

    // 영업이익
    if (ds_master.getCellData(i, "mgntAcctCd") == "5900000") {
      salesCost1 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "yearPlanAmt")) ? 0 : ds_master.getCellData(i, "yearPlanAmt"));
      salesCost2 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "bfyyThisAmt")) ? 0 : ds_master.getCellData(i, "bfyyThisAmt"));
      salesCost3 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisPlanAmt")) ? 0 : ds_master.getCellData(i, "thisPlanAmt"));
      salesCost4 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisRsltsAmt")) ? 0 : ds_master.getCellData(i, "thisRsltsAmt"));
      salesCost5 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisDiffer")) ? 0 : ds_master.getCellData(i, "thisDiffer"));
      salesCost6 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumBfyyThisAmt")) ? 0 : ds_master.getCellData(i, "sumBfyyThisAmt"));
      salesCost7 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumPlanAmt")) ? 0 : ds_master.getCellData(i, "sumPlanAmt"));
      salesCost8 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumRsltsAmt")) ? 0 : ds_master.getCellData(i, "sumRsltsAmt"));
      salesCost9 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumDiffer")) ? 0 : ds_master.getCellData(i, "sumDiffer"));
    }

    // 경상이익
    if (ds_master.getCellData(i, "mgntAcctCd") == "6700000") {
      mwound1 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "yearPlanAmt")) ? 0 : ds_master.getCellData(i, "yearPlanAmt"));
      mwound2 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "bfyyThisAmt")) ? 0 : ds_master.getCellData(i, "bfyyThisAmt"));
      mwound3 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisPlanAmt")) ? 0 : ds_master.getCellData(i, "thisPlanAmt"));
      mwound4 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisRsltsAmt")) ? 0 : ds_master.getCellData(i, "thisRsltsAmt"));
      mwound5 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisDiffer")) ? 0 : ds_master.getCellData(i, "thisDiffer"));
      mwound6 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumBfyyThisAmt")) ? 0 : ds_master.getCellData(i, "sumBfyyThisAmt"));
      mwound7 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumPlanAmt")) ? 0 : ds_master.getCellData(i, "sumPlanAmt"));
      mwound8 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumRsltsAmt")) ? 0 : ds_master.getCellData(i, "sumRsltsAmt"));
      mwound9 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumDiffer")) ? 0 : ds_master.getCellData(i, "sumDiffer"));
    }

    // 변동비용
    if (ds_master.getCellData(i, "mgntAcctCd") == "9400001") {
      vCost1 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "yearPlanAmt")) ? 0 : ds_master.getCellData(i, "yearPlanAmt"));
      vCost2 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "bfyyThisAmt")) ? 0 : ds_master.getCellData(i, "bfyyThisAmt"));
      vCost3 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisPlanAmt")) ? 0 : ds_master.getCellData(i, "thisPlanAmt"));
      vCost4 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisRsltsAmt")) ? 0 : ds_master.getCellData(i, "thisRsltsAmt"));
      vCost5 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisDiffer")) ? 0 : ds_master.getCellData(i, "thisDiffer"));
      vCost6 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumBfyyThisAmt")) ? 0 : ds_master.getCellData(i, "sumBfyyThisAmt"));
      vCost7 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumPlanAmt")) ? 0 : ds_master.getCellData(i, "sumPlanAmt"));
      vCost8 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumRsltsAmt")) ? 0 : ds_master.getCellData(i, "sumRsltsAmt"));
      vCost9 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumDiffer")) ? 0 : ds_master.getCellData(i, "sumDiffer"));
    }
  }
...
scwin.f_Profitloss = function () {
  ...
  for (let i = 0; i < ds_master.getRowCount(); i++) {
    // 영업이익, 채권금리, 재고자산금리
    if (ds_master.getCellData(i, "mgntAcctCd") == "5900000") {
      valProfit1 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "yearPlanAmt")) ? 0 : ds_master.getCellData(i, "yearPlanAmt"));
      valProfit2 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "bfyyThisAmt")) ? 0 : ds_master.getCellData(i, "bfyyThisAmt"));
      valProfit3 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisPlanAmt")) ? 0 : ds_master.getCellData(i, "thisPlanAmt"));
      valProfit4 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisRsltsAmt")) ? 0 : ds_master.getCellData(i, "thisRsltsAmt"));
      valProfit5 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisDiffer")) ? 0 : ds_master.getCellData(i, "thisDiffer"));
      valProfit6 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumBfyyThisAmt")) ? 0 : ds_master.getCellData(i, "sumBfyyThisAmt"));
      valProfit7 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumPlanAmt")) ? 0 : ds_master.getCellData(i, "sumPlanAmt"));
      valProfit8 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumRsltsAmt")) ? 0 : ds_master.getCellData(i, "sumRsltsAmt"));
      valProfit9 = Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumDiffer")) ? 0 : ds_master.getCellData(i, "sumDiffer"));
    }
    if (ds_master.getCellData(i, "mgntAcctCd") == "9800001" || ds_master.getCellData(i, "mgntAcctCd") == "9800002") {
      valProfit1 = Number(valProfit1) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "yearPlanAmt")) ? 0 : ds_master.getCellData(i, "yearPlanAmt"));
      valProfit2 = Number(valProfit2) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "bfyyThisAmt")) ? 0 : ds_master.getCellData(i, "bfyyThisAmt"));
      valProfit3 = Number(valProfit3) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisPlanAmt")) ? 0 : ds_master.getCellData(i, "thisPlanAmt"));
      valProfit4 = Number(valProfit4) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisRsltsAmt")) ? 0 : ds_master.getCellData(i, "thisRsltsAmt"));
      valProfit5 = Number(valProfit5) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisDiffer")) ? 0 : ds_master.getCellData(i, "thisDiffer"));
      valProfit6 = Number(valProfit6) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumBfyyThisAmt")) ? 0 : ds_master.getCellData(i, "sumBfyyThisAmt"));
      valProfit7 = Number(valProfit7) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumPlanAmt")) ? 0 : ds_master.getCellData(i, "sumPlanAmt"));
      valProfit8 = Number(valProfit8) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumRsltsAmt")) ? 0 : ds_master.getCellData(i, "sumRsltsAmt"));
      valProfit9 = Number(valProfit9) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumDiffer")) ? 0 : ds_master.getCellData(i, "sumDiffer"));
    }

    // 투자자산금리
    if (ds_master.getCellData(i, "mgntAcctCd") == "9800004") {
      perProfit1 = Number(valProfit1) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "yearPlanAmt")) ? 0 : ds_master.getCellData(i, "yearPlanAmt"));
      perProfit2 = Number(valProfit2) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "bfyyThisAmt")) ? 0 : ds_master.getCellData(i, "bfyyThisAmt"));
      perProfit3 = Number(valProfit3) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisPlanAmt")) ? 0 : ds_master.getCellData(i, "thisPlanAmt"));
      perProfit4 = Number(valProfit4) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisRsltsAmt")) ? 0 : ds_master.getCellData(i, "thisRsltsAmt"));
      perProfit5 = Number(valProfit5) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisDiffer")) ? 0 : ds_master.getCellData(i, "thisDiffer"));
      perProfit6 = Number(valProfit6) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumBfyyThisAmt")) ? 0 : ds_master.getCellData(i, "sumBfyyThisAmt"));
      perProfit7 = Number(valProfit7) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumPlanAmt")) ? 0 : ds_master.getCellData(i, "sumPlanAmt"));
      perProfit8 = Number(valProfit8) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumRsltsAmt")) ? 0 : ds_master.getCellData(i, "sumRsltsAmt"));
      perProfit9 = Number(valProfit9) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumDiffer")) ? 0 : ds_master.getCellData(i, "sumDiffer"));
    }
  }
...
scwin.f_AssetsAmt = function () {
  ...
  for (let i = 0; i < ds_master.getRowCount(); i++) {
    ...
    if (ds_master.getCellData(i, "mgntAcctCd") == "1110400" || ds_master.getCellData(i, "mgntAcctCd") == "1110730" || ds_master.getCellData(i, "mgntAcctCd") == "1120000" || ds_master.getCellData(i, "mgntAcctCd") == "1111100") {
      flowAmt1 = Number(flowAmt1) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "yearPlanAmt")) ? 0 : ds_master.getCellData(i, "yearPlanAmt"));
      flowAmt2 = Number(flowAmt2) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "bfyyThisAmt")) ? 0 : ds_master.getCellData(i, "bfyyThisAmt"));
      flowAmt3 = Number(flowAmt3) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisPlanAmt")) ? 0 : ds_master.getCellData(i, "thisPlanAmt"));
      flowAmt4 = Number(flowAmt4) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisRsltsAmt")) ? 0 : ds_master.getCellData(i, "thisRsltsAmt"));
      flowAmt5 = Number(flowAmt5) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisDiffer")) ? 0 : ds_master.getCellData(i, "thisDiffer"));
      flowAmt6 = Number(flowAmt6) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumBfyyThisAmt")) ? 0 : ds_master.getCellData(i, "sumBfyyThisAmt"));
      flowAmt7 = Number(flowAmt7) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumPlanAmt")) ? 0 : ds_master.getCellData(i, "sumPlanAmt"));
      flowAmt8 = Number(flowAmt8) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumRsltsAmt")) ? 0 : ds_master.getCellData(i, "sumRsltsAmt"));
      flowAmt9 = Number(flowAmt9) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumDiffer")) ? 0 : ds_master.getCellData(i, "sumDiffer"));
    }
    //대손충당금
    if (ds_master.getCellData(i, "mgntAcctCd") == "1110910" || ds_master.getCellData(i, "mgntAcctCd") == "1110920" || ds_master.getCellData(i, "mgntAcctCd") == "1110930") {
      ...
      flowAmt8 = Number(flowAmt8) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumRsltsAmt")) ? 0 : ds_master.getCellData(i, "sumRsltsAmt"));
      flowAmt9 = Number(flowAmt9) - Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumDiffer")) ? 0 : ds_master.getCellData(i, "sumDiffer"));
      mFlowAmt1 = Number(mFlowAmt1) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "yearPlanAmt")) ? 0 : ds_master.getCellData(i, "yearPlanAmt"));
      mFlowAmt2 = Number(mFlowAmt2) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "bfyyThisAmt")) ? 0 : ds_master.getCellData(i, "bfyyThisAmt"));
      mFlowAmt3 = Number(mFlowAmt3) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisPlanAmt")) ? 0 : ds_master.getCellData(i, "thisPlanAmt"));
      mFlowAmt4 = Number(mFlowAmt4) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisRsltsAmt")) ? 0 : ds_master.getCellData(i, "thisRsltsAmt"));
      mFlowAmt5 = Number(mFlowAmt5) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisDiffer")) ? 0 : ds_master.getCellData(i, "thisDiffer"));
      mFlowAmt6 = Number(mFlowAmt6) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumBfyyThisAmt")) ? 0 : ds_master.getCellData(i, "sumBfyyThisAmt"));
      mFlowAmt7 = Number(mFlowAmt7) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumPlanAmt")) ? 0 : ds_master.getCellData(i, "sumPlanAmt"));
      mFlowAmt8 = Number(mFlowAmt8) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumRsltsAmt")) ? 0 : ds_master.getCellData(i, "sumRsltsAmt"));
      mFlowAmt9 = Number(mFlowAmt9) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumDiffer")) ? 0 : ds_master.getCellData(i, "sumDiffer"));
    }
    ...
    if (ds_master.getCellData(i, "mgntAcctCd") == "1210400" || ds_master.getCellData(i, "mgntAcctCd") == "1210500" || ds_master.getCellData(i, "mgntAcctCd") == "1220000" || ds_master.getCellData(i, "mgntAcctCd") == "1230000" || ds_master.getCellData(i, "mgntAcctCd") == "1240100") {
      nonFlowAmt1 = Number(nonFlowAmt1) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "yearPlanAmt")) ? 0 : ds_master.getCellData(i, "yearPlanAmt"));
      nonFlowAmt2 = Number(nonFlowAmt2) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "bfyyThisAmt")) ? 0 : ds_master.getCellData(i, "bfyyThisAmt"));
      nonFlowAmt3 = Number(nonFlowAmt3) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisPlanAmt")) ? 0 : ds_master.getCellData(i, "thisPlanAmt"));
      nonFlowAmt4 = Number(nonFlowAmt4) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisRsltsAmt")) ? 0 : ds_master.getCellData(i, "thisRsltsAmt"));
      nonFlowAmt5 = Number(nonFlowAmt5) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisDiffer")) ? 0 : ds_master.getCellData(i, "thisDiffer"));
      nonFlowAmt6 = Number(nonFlowAmt6) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumBfyyThisAmt")) ? 0 : ds_master.getCellData(i, "sumBfyyThisAmt"));
      nonFlowAmt7 = Number(nonFlowAmt7) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumPlanAmt")) ? 0 : ds_master.getCellData(i, "sumPlanAmt"));
      nonFlowAmt8 = Number(nonFlowAmt8) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumRsltsAmt")) ? 0 : ds_master.getCellData(i, "sumRsltsAmt"));
      nonFlowAmt9 = Number(nonFlowAmt9) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumDiffer")) ? 0 : ds_master.getCellData(i, "sumDiffer"));
    }

    //건설중인자산
    if (ds_master.getCellData(i, "mgntAcctCd") == "1221000") {
      mNonFlowAmt1 = Number(mNonFlowAmt1) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "yearPlanAmt")) ? 0 : ds_master.getCellData(i, "yearPlanAmt"));
      mNonFlowAmt2 = Number(mNonFlowAmt2) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "bfyyThisAmt")) ? 0 : ds_master.getCellData(i, "bfyyThisAmt"));
      mNonFlowAmt3 = Number(mNonFlowAmt3) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisPlanAmt")) ? 0 : ds_master.getCellData(i, "thisPlanAmt"));
      mNonFlowAmt4 = Number(mNonFlowAmt4) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisRsltsAmt")) ? 0 : ds_master.getCellData(i, "thisRsltsAmt"));
      mNonFlowAmt5 = Number(mNonFlowAmt5) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "thisDiffer")) ? 0 : ds_master.getCellData(i, "thisDiffer"));
      mNonFlowAmt6 = Number(mNonFlowAmt6) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumBfyyThisAmt")) ? 0 : ds_master.getCellData(i, "sumBfyyThisAmt"));
      mNonFlowAmt7 = Number(mNonFlowAmt7) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumPlanAmt")) ? 0 : ds_master.getCellData(i, "sumPlanAmt"));
      mNonFlowAmt8 = Number(mNonFlowAmt8) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumRsltsAmt")) ? 0 : ds_master.getCellData(i, "sumRsltsAmt"));
      mNonFlowAmt9 = Number(mNonFlowAmt9) + Number($c.gus.cfIsNull($p, ds_master.getCellData(i, "sumDiffer")) ? 0 : ds_master.getCellData(i, "sumDiffer"));
    }
  }
  ...
  for (let i = 0; i < ds_master.getRowCount(); i++) {
    ...
    if (ds_master.getCellData(i, "mgntAcctCd") == "1110400") {
      ds_master.setCellData(i, "yearPlanAmt", $c.num.parseFloat($p, ds_master.getCellData(i, "yearPlanAmt")) - $c.num.parseFloat($p, mFlowAmt1));
      ds_master.setCellData(i, "bfyyThisAmt", $c.num.parseFloat($p, ds_master.getCellData(i, "bfyyThisAmt")) - $c.num.parseFloat($p, mFlowAmt2));
      ds_master.setCellData(i, "thisPlanAmt", $c.num.parseFloat($p, ds_master.getCellData(i, "thisPlanAmt")) - $c.num.parseFloat($p, mFlowAmt3));
      ds_master.setCellData(i, "thisRsltsAmt", $c.num.parseFloat($p, ds_master.getCellData(i, "thisRsltsAmt")) - $c.num.parseFloat($p, mFlowAmt4));
      ds_master.setCellData(i, "sumBfyyThisAmt", $c.num.parseFloat($p, ds_master.getCellData(i, "sumBfyyThisAmt")) - $c.num.parseFloat($p, mFlowAmt5));
      ds_master.setCellData(i, "sumPlanAmt", $c.num.parseFloat($p, ds_master.getCellData(i, "sumPlanAmt")) - $c.num.parseFloat($p, mFlowAmt6));
      ds_master.setCellData(i, "sumRsltsAmt", $c.num.parseFloat($p, ds_master.getCellData(i, "sumRsltsAmt")) - $c.num.parseFloat($p, mFlowAmt7));
    ...
    if (ds_master.getCellData(i, "mgntAcctCd") == "1200000") {
      ds_master.setCellData(i, "yearPlanAmt", nonFlowAmt1 - $c.num.parseFloat($p, mNonFlowAmt1));
      ds_master.setCellData(i, "bfyyThisAmt", nonFlowAmt2 - $c.num.parseFloat($p, mNonFlowAmt2));
      ds_master.setCellData(i, "thisPlanAmt", nonFlowAmt3 - $c.num.parseFloat($p, mNonFlowAmt3));
      ds_master.setCellData(i, "thisRsltsAmt", nonFlowAmt4 - $c.num.parseFloat($p, mNonFlowAmt4));
      ds_master.setCellData(i, "sumBfyyThisAmt", nonFlowAmt6 - $c.num.parseFloat($p, mNonFlowAmt5));
      ds_master.setCellData(i, "sumPlanAmt", nonFlowAmt6 - $c.num.parseFloat($p, mNonFlowAmt6));
      ds_master.setCellData(i, "sumRsltsAmt", nonFlowAmt8 - $c.num.parseFloat($p, mNonFlowAmt7));
    ...
    if (ds_master.getCellData(i, "mgntAcctCd") == "1220000") {
      ds_master.setCellData(i, "yearPlanAmt", $c.num.parseFloat($p, ds_master.getCellData(i, "yearPlanAmt")) - $c.num.parseFloat($p, mNonFlowAmt1));
      ds_master.setCellData(i, "bfyyThisAmt", $c.num.parseFloat($p, ds_master.getCellData(i, "bfyyThisAmt")) - $c.num.parseFloat($p, mNonFlowAmt2));
      ds_master.setCellData(i, "thisPlanAmt", $c.num.parseFloat($p, ds_master.getCellData(i, "thisPlanAmt")) - $c.num.parseFloat($p, mNonFlowAmt3));
      ds_master.setCellData(i, "thisRsltsAmt", $c.num.parseFloat($p, ds_master.getCellData(i, "thisRsltsAmt")) - $c.num.parseFloat($p, mNonFlowAmt4));
      ds_master.setCellData(i, "sumBfyyThisAmt", $c.num.parseFloat($p, ds_master.getCellData(i, "sumBfyyThisAmt")) - $c.num.parseFloat($p, mNonFlowAmt5));
      ds_master.setCellData(i, "sumPlanAmt", $c.num.parseFloat($p, ds_master.getCellData(i, "sumPlanAmt")) - $c.num.parseFloat($p, mNonFlowAmt6));
      ds_master.setCellData(i, "sumRsltsAmt", $c.num.parseFloat($p, ds_master.getCellData(i, "sumRsltsAmt")) - $c.num.parseFloat($p, mNonFlowAmt7));
