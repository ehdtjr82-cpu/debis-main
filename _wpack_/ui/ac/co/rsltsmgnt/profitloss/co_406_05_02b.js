/*amd /ui/ac/co/rsltsmgnt/profitloss/co_406_05_02b.xml 29340 295265dc56345efe2195b843de650f451ad44c394e897078d9578a432c4f7ec9 */
define({declaration:{A:{version:'1.0',encoding:'UTF-8'}},E:[{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',A:{},E:[{T:1,N:'w2:type',E:[{T:3,text:'COMPONENT'}]},{T:1,N:'w2:buildDate'},{T:1,N:'w2:MSA'},{T:1,N:'xf:model',E:[{T:1,N:'w2:dataCollection',A:{baseNode:'map'},E:[{T:1,N:'w2:dataMap',A:{baseNode:'map',id:'dma_search'},E:[{T:1,N:'w2:keyInfo',E:[{T:1,N:'w2:key',A:{id:'distClsCd',name:'결산구분',dataType:'text'}},{T:1,N:'w2:key',A:{id:'distDegCd',name:'차수',dataType:'text'}},{T:1,N:'w2:key',A:{id:'distYm',name:'배부년월',dataType:'text'}},{T:1,N:'w2:key',A:{id:'acctDeptCd',name:'부서',dataType:'text'}},{T:1,N:'w2:key',A:{id:'acctDeptNm',name:'부서명',dataType:'text'}}]}]},{T:1,N:'w2:dataList',A:{baseNode:'list',repeatNode:'map',id:'ds_distTarget',saveRemovedData:'true'},E:[{T:1,N:'w2:columnInfo',E:[{T:1,N:'w2:column',A:{id:'distDegCd',name:'차수',dataType:'text'}},{T:1,N:'w2:column',A:{id:'distRecvAcctDeptNm',name:'배부받는부서',dataType:'text'}},{T:1,N:'w2:column',A:{id:'acctCd',name:'계정코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'acctNm',name:'계정명',dataType:'text'}},{T:1,N:'w2:column',A:{id:'distGiveAcctDeptNm',name:'배부하는부서',dataType:'text'}},{T:1,N:'w2:column',A:{id:'distTrgtAmt',name:'배부대상금액',dataType:'text'}},{T:1,N:'w2:column',A:{id:'rt',name:'비율',dataType:'text'}},{T:1,N:'w2:column',A:{id:'distAmt',name:'배부금액',dataType:'text'}},{T:1,N:'w2:column',A:{id:'distStdCd',name:'배부기준',dataType:'text'}},{T:1,N:'w2:column',A:{id:'distStdAmt1',name:'계획매출액',dataType:'text'}},{T:1,N:'w2:column',A:{id:'distRt1',name:'계획매출비율',dataType:'text'}},{T:1,N:'w2:column',A:{id:'distStdAmt2',name:'인원',dataType:'text'}},{T:1,N:'w2:column',A:{id:'distRt2',name:'인원비율',dataType:'text'}},{T:1,N:'w2:column',A:{id:'distStdAmt3',name:'실적매출액',dataType:'text'}},{T:1,N:'w2:column',A:{id:'distRt3',name:'실적매출비율',dataType:'text'}},{T:1,N:'w2:column',A:{id:'distRecvAcctDeptCd',name:'배부받는귀속부서코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'distGiveAcctDeptCd',name:'배부하는부서코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'distYm',name:'배부년월',dataType:'text'}},{T:1,N:'w2:column',A:{id:'distClsCd',name:'배부구분코드',dataType:'text'}}]}]}]},{T:1,N:'xf:submission',A:{id:'sbm_retrieve',action:'/ac.co.rsltsmgnt.profitloss.RetrieveProfitlossDistributionReceivedDepartmentConsequenceCMD.do',method:'post',mediatype:'application/json',ref:'data:json,[{"id":"dma_search","key":"IN_DS1"},{"id":"ds_distTarget","key":"OUT_DS1"}]',target:'data:json,{"id":"ds_distTarget","key":"OUT_DS1"}',encoding:'UTF-8',instance:'',replace:'',errorHandler:'',customHandler:'',mode:'asynchronous',processMsg:'','ev:submit':'','ev:submitdone':'scwin.sbm_retrieve_submitdone','ev:submiterror':'',abortTrigger:''}},{T:1,N:'w2:workflowCollection'}]},{T:1,N:'w2:layoutInfo'},{T:1,N:'w2:publicInfo',A:{method:''}},{T:1,N:'script',A:{lazy:'false',type:'text/javascript'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){/**
 * 화 면 명 : 배부받는부서조회
 * 메뉴경로 : 회계/관리회계/실적관리/손익보고/배부결과조회
 * ASIS경로 : /debis/dongwon-debis-engine/src/main/webapp/ac/co/rsltsmgnt/profitloss/co_406_05_02b.jsp
 * 작 성 자 : 배기원
 * 작 업 일 : 2025-12-17
 * 작업내용 :
 *    1. 화면세팅
 ...
 * 참고사항
 * 테스트데이터 :
 *    1. 조회조건 : 결산구분[실적], 차수[전체], 배부년월[2020/01]
 * 수정이력 :
 *    - 2025-12-17      배기원    최초작성
 */
...
scwin.onpageload = function () {
  //console.log("co_406_05_01 배부받는부서조회 start");
  const codeOptions = [{
    grpCd: "CO024",
    compID: "lc_distDegCd"
  } //배부차수
...
scwin.f_Export = async function () {
  ...
  //     var exportFileName = "배부결과배부받는부서_" + ed_sacctDeptNm.getValue().trim() + "_" + ica_fromDate.getValue().trim();
  //     $c.data.downloadGridViewExcel(objGridName, "배부결과배부받는부서", exportFileName, 8 + 16);
  // }
  if (await $c.win.confirm($p, "Excel로 다운로드 하시겠습니까?")) {
    let sheetTitle = "배부결과배부받는부서";
    let options = {
...
scwin.f_openPopUp = function (orgObjCd, orgObjNm, select_code, flag) {
  ...
  // var param_yy  =  ed_FromDate.text.trim() ;
...
}}}]},{T:1,N:'w2:require',A:{as:'udc_topGrdBtn',type:'page',variableClone:'true',src:'/cm/udc/topGrdBtn.xml'}},{T:1,N:'w2:require',A:{as:'udc_comCode',type:'page',variableClone:'',src:'/cm/udc/comCode.xml'}}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload'},E:[{T:1,N:'xf:group',A:{class:'round-box',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'shbox',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'shbox-inner',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'w2tb ',id:'tbl_search',style:'',tagname:'table'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:summary'}]},{T:1,N:'xf:group',A:{tagname:'colgroup'},E:[{T:1,N:'xf:group',A:{style:'width:70px;',tagname:'col'}},{T:1,N:'xf:group',A:{style:'',tagname:'col'}},{T:1,N:'xf:group',A:{style:'width:105px;',tagname:'col'}},{T:1,N:'xf:group',A:{style:'',tagname:'col'}},{T:1,N:'xf:group',A:{tagname:'col',style:'width:60px;'}},{T:1,N:'xf:group',A:{tagname:'col'}},{T:1,N:'xf:group',A:{style:'width:60px;',tagname:'col'}},{T:1,N:'xf:group',A:{style:'',tagname:'col'}}]},{T:1,N:'xf:group',A:{class:'',id:'',style:'',tagname:'tr'},E:[{T:1,N:'xf:group',A:{class:'w2tb_th ',style:'',tagname:'th'},E:[{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'결산구분 ',style:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',style:'',tagname:'td'},E:[{T:1,N:'xf:select1',A:{appearance:'full',class:'rdo-grp',cols:'',id:'rd_distClsCd',mandatory:'true',ref:'data:dma_search.distClsCd',renderType:'radiogroup',rows:'',selectedIndex:'-1',style:'',title:'결산구분'},E:[{T:1,N:'xf:choices',E:[{T:1,N:'xf:item',E:[{T:1,N:'xf:label',E:[{T:4,cdata:'계획'}]},{T:1,N:'xf:value',E:[{T:4,cdata:'1'}]}]},{T:1,N:'xf:item',E:[{T:1,N:'xf:label',E:[{T:4,cdata:'실적'}]},{T:1,N:'xf:value',E:[{T:4,cdata:'2'}]}]}]}]}]},{T:1,N:'xf:group',A:{class:'w2tb_th',style:'',tagname:'th'},E:[{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'차수 ',style:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',id:'',style:'',tagname:'td'},E:[{T:1,N:'xf:select1',A:{allOption:'',appearance:'minimal',chooseOption:'true',class:' w150',direction:'auto',disabled:'false',disabledClass:'w2selectbox_disabled',id:'lc_distDegCd',mandatory:'true',ref:'data:dma_search.distDegCd',style:'',submenuSize:'auto',title:'차수',chooseOptionLabel:'전체'},E:[{T:1,N:'xf:choices'}]}]},{T:1,N:'xf:group',A:{class:'w2tb_th',id:'',tagname:'th'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'배부년월 ',style:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',id:'',tagname:'td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:inputCalendar',A:{calendarValueType:'yearMonth',class:' cal w80',displayFormat:'yyyy/MM',id:'ica_fromDate',mandatory:'true',objType:'data',ref:'data:dma_search.distYm',style:'',title:'배부년월'}}]},{T:1,N:'xf:group',A:{tagname:'th',id:'',class:'w2tb_th'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:scope',E:[{T:3,text:'row'}]}]},{T:1,N:'w2:textbox',A:{class:'',id:'',label:'부서 ',style:''}}]},{T:1,N:'xf:group',A:{tagname:'td',id:'',class:'w2tb_td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:udc_comCode',A:{allowCharCode:'0-9',btnId:'btn_sacctDeptCd',code:'acctDeptCd',codeId:'ed_sacctDeptCd',editTypeCode:'focus','ev:onclickEvent':'scwin.udc_sacctDeptCd_onclickEvent','ev:onviewchangeCodeEvent':'scwin.udc_sacctDeptCd_onviewchangeCodeEvent',id:'udc_sacctDeptCd',mandatoryCode:'',maxlengthCode:'5',maxlengthName:'30',name:'acctDeptNm',nameId:'ed_sacctDeptNm',objTypeCode:'data',objTypeName:'key',popupID:'popup_sacctDeptCd',refDataCollection:'dma_search',selectID:'retrieveAcctDeptCdInfo5',style:'',validExpCode:'부서',validTitle:'부서','ev:onviewchangeNameEvent':'scwin.udc_sacctDeptCd_onviewchangeNameEvent'}}]}]}]}]},{T:1,N:'xf:group',A:{class:'btn-shbox',id:'',style:''},E:[{T:1,N:'xf:trigger',A:{class:'btn ico refresh','ev:onclick':'scwin.f_FieldClear',id:'btn_fieldClear',style:'',type:'button'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'새로고침'}]}]},{T:1,N:'xf:trigger',A:{class:'btn sch',disabled:'','ev:onclick':'scwin.f_Retrieve',id:'btn_search',style:'',type:'button',userAuth:'R'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'조회'}]}]}]}]},{T:1,N:'xf:group',A:{class:'title-wrap',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'title',id:''},E:[{T:1,N:'w2:textbox',A:{class:'tit',id:'',label:'배부대상금액 ',style:'',tagname:'h3'}}]},{T:1,N:'xf:group',A:{class:'right',id:''},E:[{T:1,N:'w2:udc_topGrdBtn',A:{gridID:'gr_distTarget',gridUpYn:'N',grp:'grd_section1',id:'udc_excel',style:'',templateYn:'N',gridDownFn:'scwin.f_Export',gridDownUserAuth:'X'}}]}]},{T:1,N:'xf:group',A:{adaptiveThreshold:'',class:'gvwbox',id:'grd_section1',style:''},E:[{T:1,N:'w2:gridView',A:{autoFit:'noen',checkReadOnlyOnPasteEnable:'',class:'wq_gvw',dataList:'data:ds_distTarget',focusMode:'cell',id:'gr_distTarget',scrollByColumn:'false',scrollByColumnAdaptive:'false',style:'',visibleRowNum:'14',visibleRowNumFix:'true',readOnly:'true',gridName:'배부받는부서'},E:[{T:1,N:'w2:caption',A:{id:'caption1',style:'',value:'this is a grid caption.'}},{T:1,N:'w2:header',A:{id:'header2',style:''},E:[{T:1,N:'w2:row',A:{id:'row3',style:''},E:[{T:1,N:'w2:column',A:{displayMode:'label',id:'column30',inputType:'text',style:'',value:'차수',width:'70'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column38',inputType:'text',style:'',value:'배부받는부서',width:'180'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column36',inputType:'text',style:'',value:'계정코드',width:'120'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column34',inputType:'text',style:'',value:'계정명',width:'180'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column32',inputType:'text',style:'',value:'배부하는부서',width:'180'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column28',inputType:'text',style:'',value:'배부대상금액',width:'150'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column26',inputType:'text',style:'',value:'비율(%)',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column22',inputType:'text',style:'',value:'배부금액',width:'160'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column24',inputType:'text',style:'',value:'배부기준',width:'180'}},{T:1,N:'w2:column',A:{width:'120',inputType:'text',style:'',id:'column55',value:'계획매출액',displayMode:'label'}},{T:1,N:'w2:column',A:{width:'150',inputType:'text',style:'',id:'column49',value:'계획매출비율',displayMode:'label'}},{T:1,N:'w2:column',A:{width:'140',inputType:'text',style:'',id:'column52',value:'인원',displayMode:'label'}},{T:1,N:'w2:column',A:{width:'80',inputType:'text',style:'',id:'column76',value:'인원비율',displayMode:'label'}},{T:1,N:'w2:column',A:{width:'140',inputType:'text',style:'',id:'column73',value:'실적매출액',displayMode:'label'}},{T:1,N:'w2:column',A:{width:'120',inputType:'text',style:'',id:'column70',value:'실적매출비율',displayMode:'label'}},{T:1,N:'w2:column',A:{width:'100',inputType:'text',style:'',id:'column67',value:'배부받는귀속부서코드',displayMode:'label'}},{T:1,N:'w2:column',A:{width:'100',inputType:'text',style:'',id:'column58',value:'배부하는부서코드',displayMode:'label'}},{T:1,N:'w2:column',A:{width:'100',inputType:'text',style:'',id:'column61',value:'배부년월',displayMode:'label'}},{T:1,N:'w2:column',A:{width:'100',inputType:'text',style:'',id:'column64',value:'배부구분코드',displayMode:'label'}}]}]},{T:1,N:'w2:gBody',A:{id:'gBody2',style:''},E:[{T:1,N:'w2:row',A:{id:'row4',style:''},E:[{T:1,N:'w2:column',A:{id:'distDegCd',name:'차수',width:'70',textAlign:'center',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distRecvAcctDeptNm',name:'배부받는부서',width:'180',textAlign:'left',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'acctCd',name:'계정코드',width:'120',textAlign:'center',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'acctNm',name:'계정명',width:'180',textAlign:'left',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distGiveAcctDeptNm',name:'배부하는부서',width:'180',textAlign:'left',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distTrgtAmt',name:'배부대상금액',width:'150',textAlign:'right',displayMode:'label',inputType:'text',style:'',value:'',dataType:'number',displayFormat:'#,###',excelCellType:'number',excelFormat:'#,##0'}},{T:1,N:'w2:column',A:{id:'rt',name:'비율',width:'100',textAlign:'right',dataType:'number',displayFormat:'#,##0.00',displayMode:'label',inputType:'text',style:'',value:'',excelCellType:'number',excelFormat:'#,##0.00'}},{T:1,N:'w2:column',A:{id:'distAmt',name:'배부금액',width:'160',textAlign:'right',displayMode:'label',inputType:'text',style:'',value:'',dataType:'number',displayFormat:'#,###',excelCellType:'number',excelFormat:'#,##0'}},{T:1,N:'w2:column',A:{id:'distStdCd',name:'배부기준',width:'180',textAlign:'left',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distStdAmt1',name:'계획매출액',width:'120',textAlign:'right',hidden:'false',dataType:'number',displayFormat:'#,###',displayMode:'label',inputType:'text',style:'',value:'',excelCellType:'number',excelFormat:'#,##0'}},{T:1,N:'w2:column',A:{id:'distRt1',name:'계획매출비율',width:'150',textAlign:'right',hidden:'false',dataType:'number',displayFormat:'#,###.00',displayMode:'label',inputType:'text',style:'',value:'',excelCellType:'number',excelFormat:'#,##0.00'}},{T:1,N:'w2:column',A:{id:'distStdAmt2',name:'인원',width:'140',textAlign:'right',hidden:'false',dataType:'number',displayFormat:'#,###',displayMode:'label',inputType:'text',style:'',value:'',excelCellType:'number',excelFormat:'#,##0'}},{T:1,N:'w2:column',A:{id:'distRt2',name:'인원비율',width:'80',textAlign:'right',hidden:'false',dataType:'number',displayFormat:'#,###.00',displayMode:'label',inputType:'text',style:'',value:'',excelCellType:'number',excelFormat:'#,##0.00'}},{T:1,N:'w2:column',A:{id:'distStdAmt3',name:'실적매출액',width:'140',textAlign:'right',hidden:'false',dataType:'number',displayFormat:'#,###',displayMode:'label',inputType:'text',style:'',value:'',excelCellType:'number',excelFormat:'#,##0'}},{T:1,N:'w2:column',A:{id:'distRt3',name:'실적매출비율',width:'120',textAlign:'right',hidden:'false',dataType:'number',displayFormat:'#,###.00',displayMode:'label',inputType:'text',style:'',value:'',excelCellType:'number',excelFormat:'#,##0.00'}},{T:1,N:'w2:column',A:{id:'distRecvAcctDeptCd',name:'배부받는귀속부서코드',width:'100',textAlign:'center',hidden:'true',hiddenCol:'true',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distGiveAcctDeptCd',name:'배부하는부서코드',width:'100',textAlign:'center',hidden:'true',hiddenCol:'true',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distYm',name:'배부년월',width:'100',textAlign:'center',hidden:'true',hiddenCol:'true',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distClsCd',name:'배부구분코드',width:'100',textAlign:'center',hidden:'true',hiddenCol:'true',displayMode:'label',inputType:'text',style:'',value:''}}]}]},{T:1,N:'w2:footer',A:{id:'footer1',style:''},E:[{T:1,N:'w2:row',A:{id:'row5',style:''},E:[{T:1,N:'w2:column',A:{id:'distDegCd_s1',name:'차수',width:'70',textAlign:'center',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distRecvAcctDeptNm_s1',name:'배부받는부서',width:'180',textAlign:'left',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'acctCd_s1',name:'계정코드',width:'120',textAlign:'center',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'acctNm_s1',name:'계정명',width:'180',textAlign:'left',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distGiveAcctDeptNm_s1',name:'배부하는부서',width:'180',textAlign:'center',displayMode:'label',inputType:'text',style:'',value:'합계'}},{T:1,N:'w2:column',A:{id:'distTrgtAmt_s1',name:'배부대상금액',width:'150',textAlign:'right',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'rt_s1',name:'비율',width:'100',textAlign:'right',dataType:'number',displayFormat:'#,###.00',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distAmt_s1',name:'배부금액',width:'160',textAlign:'right',dataType:'number',displayFormat:'#,##0',displayMode:'label',inputType:'expression',expression:'SUM("distAmt")',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distStdCd_s1',name:'배부기준',width:'180',textAlign:'left',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distStdAmt1_s1',name:'계획매출액',width:'120',textAlign:'right',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distRt1_s1',name:'계획매출비율',width:'150',textAlign:'right',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distStdAmt2_s1',name:'인원',width:'140',textAlign:'right',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distRt2_s1',name:'인원비율',width:'100',textAlign:'right',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distStdAmt3_s1',name:'실적매출액',width:'140',textAlign:'right',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distRt3_s1',name:'실적매출비율',width:'120',textAlign:'right',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distRecvAcctDeptCd_s1',name:'배부받는귀속부서코드',width:'100',textAlign:'center',hidden:'true',hiddenCol:'true',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distGiveAcctDeptCd_s1',name:'배부하는부서코드',width:'100',textAlign:'center',hidden:'true',hiddenCol:'true',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distYm_s1',name:'배부년월',width:'100',textAlign:'center',hidden:'true',hiddenCol:'true',displayMode:'label',inputType:'text',style:'',value:''}},{T:1,N:'w2:column',A:{id:'distClsCd_s1',name:'배부구분코드',width:'100',textAlign:'center',hidden:'true',hiddenCol:'true',displayMode:'label',inputType:'text',style:'',value:''}}]}]}]},{T:1,N:'xf:group',A:{class:'grid-bottom ',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'left',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'grid-total',id:''},E:[{T:1,N:'w2:textbox',A:{class:'',id:'',label:'총',style:'',tagname:'span'}},{T:1,N:'w2:textbox',A:{class:'num',dataType:'number',displayFormat:'#,##0',id:'totalRows',label:'0',style:'',tagname:'span'}},{T:1,N:'w2:textbox',A:{class:'',id:'',label:'건',style:'',tagname:'span'}}]}]}]}]}]}]}]}]})