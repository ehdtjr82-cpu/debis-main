/*amd /ui/ac/co/rsltsmgnt/profitloss/co_406_05_00b.xml 2328 e9ad07a5e2ceea5a25967f3ec7b7d5a49119000abed9664277647fb036bf5198 */
 ...
 * ASIS경로 : /debis/dongwon-debis-engine/src/main/webapp/ac/co/rsltsmgnt/profitloss/co_406_05_00b.jsp
 * 작 성 자 : 배기원
 * 작 업 일 : 2025-12-17
 * 작업내용 :
 *    1. 화면세팅
 * 참고사항
 *    1. 탭 메인화면 : 배부하는부서조회[co_406_05_01b.xml], 배부받는부서조회[co_406_05_02b.xml], 배부대상금액조회[co_406_05_03b.xml]
 * 수정이력 :
 *    - 2025-12-17      배기원    최초작성
 */

scwin.onpageload = function () {
  //console.log("co_406_05_00 탭메인화면 start");
};
}}}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload'},E:[{T:1,N:'xf:group',A:{class:'sub_contents',id:'',style:''},E:[{T:1,N:'w2:wframe',A:{id:'',src:'/cm/xml/contentHeader.xml',style:''}},{T:1,N:'xf:group',A:{id:'',class:'tabbox'},E:[{T:1,N:'xf:group',A:{id:'',class:'wq_tab'},E:[{T:1,N:'w2:tabControl',A:{alwaysDraw:'false',style:'',id:'',class:''},E:[{T:1,N:'w2:tabs',A:{disabled:'false',style:'',id:'tabs1',label:'배부하는 부서조회'}},{T:1,N:'w2:tabs',A:{disabled:'false',style:'',id:'tabs2',label:'배부받는 부서조회'}},{T:1,N:'w2:tabs',A:{disabled:'false',style:'',id:'tabs3',label:'배부대상 금액조회'}},{T:1,N:'w2:content',A:{src:'/ui/ac/co/rsltsmgnt/profitloss/co_406_05_01b.xml',alwaysDraw:'false',style:'',id:'content1',scope:'true'}},{T:1,N:'w2:content',A:{src:'/ui/ac/co/rsltsmgnt/profitloss/co_406_05_02b.xml',alwaysDraw:'false',style:'',id:'content2',scope:'true'}},{T:1,N:'w2:content',A:{src:'/ui/ac/co/rsltsmgnt/profitloss/co_406_05_03b.xml',alwaysDraw:'false',style:'',id:'content3',scope:'true'}}]}]}]}]}]}]}]})