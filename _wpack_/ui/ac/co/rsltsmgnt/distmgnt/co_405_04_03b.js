 ...
 * 테스트데이터 :
 *    1. 회사코드[000], 결산구분[계획], 차수[3차], 배부년월[202001], 버전[002], 부서[00048]
 * 수정이력 :
 *    - 2025-12-18      배기원    최초작성
 */
//hidden 값
...
scwin.f_openPopUp = function (orgObjCd, orgObjNm, select_code, flag, close) {
  ...
  switch (select_code) {
    case "1":
      //귀속부서
      udc_sacctDeptCd.cfCommonPopUp(scwin.udc_sacctDeptCd_callBackFunc, orgObjCd.getValue(), orgObjNm.getValue(), close, null, null, null, null, param, null, null, null, null, null, "F", null, null);
      break;
    default:
      break;
  }
...
scwin.udc_sacctDeptCd_onviewchangeNameEvent = function (info) {
  ...
  if (!$c.gus.cfIsNull($p, ed_sacctDeptNm.getValue())) {
    // scwin.f_CheckPopUp(ed_sacctDeptCd,ed_sacctDeptNm,'1','CD')
    scwin.f_openPopUp(ed_sacctDeptCd, ed_sacctDeptNm, "1", "NM", "T");
  }
};
}}}]},{T:1,N:'w2:require',A:{as:'udc_comCode',type:'page',variableClone:'true',src:'/cm/udc/comCode.xml'}},{T:1,N:'w2:require',A:{as:'udc_topGrdBtn',type:'page',variableClone:'true',src:'/cm/udc/topGrdBtn.xml'}}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload'},E:[{T:1,N:'xf:group',A:{id:'grp_group1',class:'round-box'},E:[{T:1,N:'xf:group',A:{style:'',id:'',class:'shbox'},E:[{T:1,N:'xf:group',A:{style:'',id:'',class:'shbox-inner'},E:[{T:1,N:'xf:group',A:{tagname:'table',style:'',id:'tbl_search',class:'w2tb'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:summary'}]},{T:1,N:'xf:group',A:{tagname:'colgroup'},E:[{T:1,N:'xf:group',A:{tagname:'col',style:'width:75px;'}},{T:1,N:'xf:group',A:{tagname:'col',style:'width:25.00%;'}},{T:1,N:'xf:group',A:{tagname:'col',style:'width:75px;'}},{T:1,N:'xf:group',A:{tagname:'col',style:''}},{T:1,N:'xf:group',A:{tagname:'col',style:'width:50px;'}},{T:1,N:'xf:group',A:{tagname:'col',style:''}},{T:1,N:'xf:group',A:{tagname:'col',style:'width:75px;'}},{T:1,N:'xf:group',A:{tagname:'col'}},{T:1,N:'xf:group',A:{tagname:'col',style:'width:50px;'}},{T:1,N:'xf:group',A:{tagname:'col',style:''}}]},{T:1,N:'xf:group',A:{tagname:'tr',style:'',id:'',class:''},E:[{T:1,N:'xf:group',A:{tagname:'th',style:'',class:'w2tb_th '},E:[{T:1,N:'w2:textbox',A:{style:'',id:'',label:'회사코드 ',class:'req'}}]},{T:1,N:'xf:group',A:{tagname:'td',style:'',class:'w2tb_td'},E:[{T:1,N:'w2:udc_comCode',A:{allowCharCode:'0-9',btnId:'btn_company',code:'coCd',codeId:'ed_coCd',editTypeCode:'focus','ev:onclickEvent':'scwin.udc_comCode_onclickEvent','ev:onviewchangeCodeEvent':'scwin.udc_comCode_onviewchangeCodeEvent',id:'udc_comCode',mandatoryCode:'true',maxlengthCode:'3',maxlengthName:'30',name:'coNm',nameId:'ed_coNm',objTypeCode:'data',objTypeName:'key',popupID:'popupCocd',refDataCollection:'dma_search',selectID:'retrieveDongbuGroupCompanyInfo',style:'',validExpCode:'회사코드',validTitle:'회사코드',codeWidth:'50'}}]},{T:1,N:'xf:group',A:{tagname:'th',style:'',class:'w2tb_th'},E:[{T:1,N:'w2:textbox',A:{style:'',id:'',label:'결산구분 ',class:'req'}}]},{T:1,N:'xf:group',A:{tagname:'td',style:'',id:'',class:'w2tb_td'},E:[{T:1,N:'xf:select1',A:{appearance:'full',class:'rdo-grp',cols:'',id:'rd_distClsCd',mandatory:'true',ref:'data:dma_search.distClsCd',renderType:'radiogroup',rows:'',selectedIndex:'1',style:'',title:'결산구분'},E:[{T:1,N:'xf:choices',E:[{T:1,N:'xf:item',E:[{T:1,N:'xf:label',E:[{T:4,cdata:'계획'}]},{T:1,N:'xf:value',E:[{T:4,cdata:'1'}]}]},{T:1,N:'xf:item',E:[{T:1,N:'xf:label',E:[{T:4,cdata:'실적'}]},{T:1,N:'xf:value',E:[{T:4,cdata:'2'}]}]}]}]}]},{T:1,N:'xf:group',A:{tagname:'th',id:'',class:'w2tb_th'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:textbox',A:{style:'',id:'',label:'차수 ',class:'req'}}]},{T:1,N:'xf:group',A:{tagname:'td',id:'',class:'w2tb_td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'xf:select1',A:{allOption:'',appearance:'minimal',chooseOption:'true',chooseOptionLabel:'전체',class:' w120',direction:'auto',disabled:'false',disabledClass:'w2selectbox_disabled',id:'lc_distDegCd',mandatory:'true',ref:'data:dma_search.distDegCd',style:'',submenuSize:'auto',title:'차수'},E:[{T:1,N:'xf:choices'}]}]},{T:1,N:'xf:group',A:{tagname:'th',id:'',class:'w2tb_th'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:textbox',A:{style:'',id:'',label:'배부년월 ',class:'req'}}]},{T:1,N:'xf:group',A:{tagname:'td',id:'',class:'w2tb_td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:inputCalendar',A:{calendarValueType:'yearMonth',class:' cal w80',displayFormat:'yyyy/MM',id:'ica_fromDate',mandatory:'true',objType:'data',ref:'data:dma_search.distYm',style:'',title:'배부년월','ev:onblur':'scwin.ica_fromDate_onblur',nextTabID:'lc_version'}}]},{T:1,N:'xf:group',A:{tagname:'th',id:'',class:'w2tb_th'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:textbox',A:{style:'',id:'',label:'버전 ',class:'req'}}]},{T:1,N:'xf:group',A:{tagname:'td',id:'',class:'w2tb_td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'xf:select1',A:{allOption:'',appearance:'minimal',chooseOption:'',class:'form-control w150',direction:'auto',disabled:'false',disabledClass:'w2selectbox_disabled',displayMode:'value delim label',id:'lc_version',mandatory:'true',ref:'data:dma_search.ver',style:'',submenuSize:'auto',tabIndex:'-1',title:'버전',validExp:'버전:yes'},E:[{T:1,N:'xf:choices',E:[{T:1,N:'xf:itemset',A:{nodeset:'data:ds_version'},E:[{T:1,N:'xf:label',A:{ref:'col4'}},{T:1,N:'xf:value',A:{ref:'col1'}}]}]}]}]}]},{T:1,N:'xf:group',A:{tagname:'tr',style:'',id:'',class:''},E:[{T:1,N:'xf:group',A:{tagname:'th',style:'',class:'w2tb_th'},E:[{T:1,N:'w2:textbox',A:{style:'',id:'',label:'부서',class:''}}]},{T:1,N:'xf:group',A:{tagname:'td',style:'',class:'w2tb_td'},E:[{T:1,N:'w2:udc_comCode',A:{allowCharCode:'0-9',btnId:'btn_sacctDeptCd',code:'acctDeptCd',codeId:'ed_sacctDeptCd',editTypeCode:'focus','ev:onclickEvent':'scwin.udc_sacctDeptCd_onclickEvent','ev:onviewchangeCodeEvent':'scwin.udc_sacctDeptCd_onviewchangeCodeEvent',id:'udc_sacctDeptCd',mandatoryCode:'',maxlengthCode:'5',maxlengthName:'30',name:'acctDeptNm',nameId:'ed_sacctDeptNm',objTypeCode:'data',objTypeName:'key',popupID:'popup_sacctDeptCd',refDataCollection:'dma_search',selectID:'retrieveAcctDeptCdInfo5',style:'',validExpCode:'부서',validTitle:'부서','ev:onviewchangeNameEvent':'scwin.udc_sacctDeptCd_onviewchangeNameEvent'}}]},{T:1,N:'xf:group',A:{tagname:'th',style:'',class:'w2tb_th'}},{T:1,N:'xf:group',A:{tagname:'td',style:'',id:'',class:'w2tb_td'}},{T:1,N:'xf:group',A:{tagname:'th',id:'',class:'w2tb_th'},E:[{T:1,N:'w2:attributes'}]},{T:1,N:'xf:group',A:{tagname:'td',id:'',class:'w2tb_td'},E:[{T:1,N:'w2:attributes'}]},{T:1,N:'xf:group',A:{tagname:'th',id:'',class:'w2tb_th'},E:[{T:1,N:'w2:attributes'}]},{T:1,N:'xf:group',A:{tagname:'td',id:'',class:'w2tb_td'},E:[{T:1,N:'w2:attributes'}]},{T:1,N:'xf:group',A:{tagname:'th',id:'',class:'w2tb_th'},E:[{T:1,N:'w2:attributes'}]},{T:1,N:'xf:group',A:{tagname:'td',id:'',class:'w2tb_td'},E:[{T:1,N:'w2:attributes'}]}]}]}]},{T:1,N:'xf:group',A:{style:'',id:'',class:'btn-shbox'},E:[{T:1,N:'xf:trigger',A:{class:'btn ico refresh','ev:onclick':'scwin.f_FieldClear',id:'btn_fieldClear',style:'',type:'button'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'새로고침'}]}]},{T:1,N:'xf:trigger',A:{class:'btn sch',disabled:'','ev:onclick':'scwin.f_Retrieve',id:'btn_search',style:'',type:'button',userAuth:'R'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'조회'}]}]}]}]},{T:1,N:'xf:group',A:{style:'',id:'',class:'title-wrap'},E:[{T:1,N:'xf:group',A:{id:'',class:'title'},E:[{T:1,N:'w2:textbox',A:{tagname:'h3',style:'',id:'',label:'배부대상금액 ',class:'tit'}}]},{T:1,N:'xf:group',A:{id:'',class:'right'},E:[{T:1,N:'w2:udc_topGrdBtn',A:{gridDownFn:'scwin.f_Export',gridID:'gr_distTarget',gridUpYn:'N',grp:'grd_section1',id:'udc_excel',style:'',templateYn:'N'}}]}]},{T:1,N:'xf:group',A:{adaptiveThreshold:'',style:'',id:'grd_section1',class:'gvwbox'},E:[{T:1,N:'w2:gridView',A:{autoFit:'allColumn',checkReadOnlyOnPasteEnable:'',class:'wq_gvw',dataList:'data:ds_distTarget',focusMode:'cell',id:'gr_distTarget',scrollByColumn:'false',scrollByColumnAdaptive:'false',style:'',visibleRowNum:'15',visibleRowNumFix:'true',readOnly:'true',gridName:'배부하는부서'},E:[{T:1,N:'w2:caption',A:{id:'caption1',style:'',value:'this is a grid caption.'}},{T:1,N:'w2:header',A:{id:'header2',style:''},E:[{T:1,N:'w2:row',A:{id:'row3',style:''},E:[{T:1,N:'w2:column',A:{displayMode:'label',id:'column30',inputType:'text',style:'',value:'차수',width:'70'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column38',inputType:'text',style:'',value:'배부하는부서',width:'200'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column36',inputType:'text',style:'',value:'계정코드',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column34',inputType:'text',style:'',value:'계정명',width:'300'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column79',inputType:'text',style:'',value:'배부대상금액',width:'120'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column32',inputType:'text',style:'',value:'배부받는부서',width:'200'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column26',inputType:'text',style:'',value:'비율(%) ',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column22',inputType:'text',style:'',value:'배부금액',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column24',inputType:'text',style:'',value:'배부받는귀속부서코드',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column55',inputType:'text',style:'',value:'배부하는부서코드',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column80',inputType:'text',style:'',value:'버전',width:'70'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column49',inputType:'text',style:'',value:'배부년월',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column52',inputType:'text',style:'',value:'배부구분코드',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column76',inputType:'text',style:'',value:'배부기준금액1',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column73',inputType:'text',style:'',value:'배부비율1',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column70',inputType:'text',style:'',value:'배부기준금액2',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column67',inputType:'text',style:'',value:'배부비율2',width:'100'}}]}]},{T:1,N:'w2:gBody',A:{id:'gBody2',style:''},E:[{T:1,N:'w2:row',A:{id:'row4',style:''},E:[{T:1,N:'w2:column',A:{displayMode:'label',id:'distDegCd',inputType:'text',name:'차수',style:'',textAlign:'center',value:'',width:'70'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'distGiveAcctDeptNm',inputType:'text',name:'배부하는부서',style:'',textAlign:'left',value:'',width:'200'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'acctCd',inputType:'text',name:'계정코드',style:'',textAlign:'center',value:'',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'acctNm',inputType:'text',name:'계정명',style:'',textAlign:'left',value:'',width:'300'}},{T:1,N:'w2:column',A:{dataType:'number',displayFormat:'#,###',displayMode:'label',id:'distTrgtAmt',inputType:'text',name:'배부대상금액',style:'',textAlign:'right',value:'',width:'120',excelCellType:'number',excelFormat:'#,##0'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'distRecvAcctDeptNm',inputType:'text',name:'배부받는부서',style:'',textAlign:'left',value:'',width:'200'}},{T:1,N:'w2:column',A:{dataType:'number',displayFormat:'#,###.00',displayMode:'label',id:'rt',inputType:'text',name:'비율',style:'',textAlign:'right',value:'',width:'100',excelCellType:'number',excelFormat:'#,##0.00'}},{T:1,N:'w2:column',A:{dataType:'number',displayFormat:'#,###',displayMode:'label',id:'distAmt',inputType:'text',name:'배부금액',style:'',textAlign:'right',value:'',width:'100',excelCellType:'number',excelFormat:'#,##0'}},{T:1,N:'w2:column',A:{displayMode:'label',hidden:'true',hiddenCol:'true',id:'distRecvAcctDeptCd',inputType:'text',name:'배부받는귀속부서코드',style:'',textAlign:'center',value:'',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',hidden:'true',hiddenCol:'true',id:'distGiveAcctDeptCd',inputType:'text',name:'배부하는부서코드',style:'',textAlign:'center',value:'',width:'100'}},{T:1,N:'w2:column',A:{width:'70',inputType:'text',style:'',id:'ver',value:'',displayMode:'label',hiddenCol:'true',hidden:'true',name:'버전'}},{T:1,N:'w2:column',A:{displayMode:'label',hidden:'true',hiddenCol:'true',id:'distYm',inputType:'text',name:'배부년월',style:'',textAlign:'center',value:'',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',hidden:'true',hiddenCol:'true',id:'distClsCd',inputType:'text',name:'배부구분코드',style:'',textAlign:'center',value:'',width:'100'}},{T:1,N:'w2:column',A:{dataType:'number',displayFormat:'#,###',displayMode:'label',hidden:'true',hiddenCol:'true',id:'distStdAmt1',inputType:'text',name:'배부기준금액',style:'',textAlign:'right',value:'',width:'100',excelCellType:'number',excelFormat:'#,##0'}},{T:1,N:'w2:column',A:{dataType:'number',displayFormat:'#,###.00',displayMode:'label',hidden:'true',hiddenCol:'true',id:'distRt1',inputType:'text',name:'배부비율',style:'',textAlign:'center',value:'',width:'100',excelCellType:'number',excelFormat:'#,##0.00'}},{T:1,N:'w2:column',A:{dataType:'number',displayFormat:'#,###',displayMode:'label',hidden:'true',hiddenCol:'true',id:'distStdAmt2',inputType:'text',name:'배부기준금액',style:'',textAlign:'right',value:'',width:'100',excelCellType:'number',excelFormat:'#,##0'}},{T:1,N:'w2:column',A:{dataType:'number',displayFormat:'#,###.00',displayMode:'label',hidden:'true',hiddenCol:'true',id:'distRt2',inputType:'text',name:'배부비율',style:'',textAlign:'center',value:'',width:'100',excelCellType:'number',excelFormat:'#,##0.00'}}]}]},{T:1,N:'w2:footer',A:{id:'footer1',style:''},E:[{T:1,N:'w2:row',A:{id:'row5',style:''},E:[{T:1,N:'w2:column',A:{displayMode:'label',id:'distDegCd_s1',inputType:'text',name:'차수',style:'',textAlign:'center',value:'',width:'70'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'distGiveAcctDeptNm_s1',inputType:'text',name:'배부하는부서',style:'',textAlign:'left',value:'',width:'200'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'acctCd_s1',inputType:'text',name:'계정코드',style:'',textAlign:'center',value:'',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'acctNm_s1',inputType:'text',name:'계정명',style:'',textAlign:'left',value:'합계',width:'200'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'distTrgtAmt_s1',inputType:'text',name:'배부대상금액',style:'',textAlign:'right',value:'',width:'120'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'distRecvAcctDeptNm_s1',inputType:'text',name:'배부받는부서',style:'',textAlign:'left',value:'',width:'200'}},{T:1,N:'w2:column',A:{dataType:'text',displayMode:'label',id:'rt_s1',inputType:'text',name:'비율',style:'',textAlign:'right',value:'',width:'100'}},{T:1,N:'w2:column',A:{dataType:'number',displayFormat:'#,##0',displayMode:'label',expression:'SUM("distAmt")',id:'distAmt_s1',inputType:'expression',name:'배부금액',style:'',textAlign:'right',value:'',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',hidden:'true',hiddenCol:'true',id:'distRecvAcctDeptCd_s1',inputType:'text',name:'배부받는귀속부서코드',style:'',textAlign:'center',value:'',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',hidden:'true',hiddenCol:'true',id:'distGiveAcctDeptCd_s1',inputType:'text',name:'배부하는부서코드',style:'',textAlign:'center',value:'',width:'100'}},{T:1,N:'w2:column',A:{width:'70',inputType:'text',style:'',id:'ver_s1',value:'',displayMode:'label',hidden:'true',hiddenCol:'true'}},{T:1,N:'w2:column',A:{displayMode:'label',hidden:'true',hiddenCol:'true',id:'distYm_s1',inputType:'text',name:'배부년월',style:'',textAlign:'center',value:'',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',hidden:'true',hiddenCol:'true',id:'distClsCd_s1',inputType:'text',name:'배부구분코드',style:'',textAlign:'center',value:'',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',hidden:'true',hiddenCol:'true',id:'distStdAmt1_s1',inputType:'text',name:'배부기준금액',style:'',textAlign:'center',value:'',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',hidden:'true',hiddenCol:'true',id:'distRt1_s1',inputType:'text',name:'배부비율',style:'',textAlign:'center',value:'',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',hidden:'true',hiddenCol:'true',id:'distStdAmt2_s1',inputType:'text',name:'배부기준금액',style:'',textAlign:'center',value:'',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',hidden:'true',hiddenCol:'true',id:'distRt2_s1',inputType:'text',name:'배부비율',style:'',textAlign:'center',value:'',width:'100'}}]}]}]},{T:1,N:'xf:group',A:{style:'',id:'',class:'grid-bottom '},E:[{T:1,N:'xf:group',A:{id:'',class:'left'},E:[{T:1,N:'xf:group',A:{id:'',class:'grid-total'},E:[{T:1,N:'w2:textbox',A:{tagname:'span',style:'',id:'',label:'총',class:''}},{T:1,N:'w2:textbox',A:{class:'num',dataType:'number',displayFormat:'#,##0',id:'totalRows',label:'0',style:'',tagname:'span'}},{T:1,N:'w2:textbox',A:{tagname:'span',style:'',id:'',label:'건',class:''}}]}]}]}]}]}]}]}]})