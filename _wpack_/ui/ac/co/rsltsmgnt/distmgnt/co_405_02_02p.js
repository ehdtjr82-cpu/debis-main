/*amd /ui/ac/co/rsltsmgnt/distmgnt/co_405_02_02p.xml 25345 a7b73ca03185c4970d13b6e1157efd6875136aecbf7d06fb777aaa8e7c526bc6 */
define({declaration:{A:{version:'1.0',encoding:'UTF-8'}},E:[{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',A:{},E:[{T:1,N:'w2:type',E:[{T:3,text:'COMPONENT'}]},{T:1,N:'w2:buildDate'},{T:1,N:'w2:MSA'},{T:1,N:'xf:model',E:[{T:1,N:'w2:dataCollection',A:{baseNode:'map'},E:[{T:1,N:'w2:dataMap',A:{baseNode:'map',id:'dma_master'},E:[{T:1,N:'w2:keyInfo',E:[{T:1,N:'w2:key',A:{id:'coCd',name:'회사코드',dataType:'text'}},{T:1,N:'w2:key',A:{id:'coNm',name:'회사명',dataType:'text'}},{T:1,N:'w2:key',A:{id:'stdYm',name:'기준년월',dataType:'text'}},{T:1,N:'w2:key',A:{id:'creatYmFrom',name:'반영할기간From',dataType:'text'}},{T:1,N:'w2:key',A:{id:'creatYmTo',name:'반영할기간To',dataType:'text'}},{T:1,N:'w2:key',A:{id:'distAcctDeptCd',name:'부서코드',dataType:'text'}},{T:1,N:'w2:key',A:{id:'distAcctDeptNm',name:'부서명',dataType:'text'}}]}]},{T:1,N:'w2:dataList',A:{baseNode:'list',repeatNode:'map',id:'ds_giveDept',saveRemovedData:'false'},E:[{T:1,N:'w2:columnInfo',E:[{T:1,N:'w2:column',A:{id:'distYm',name:'배부년월',dataType:'text'}},{T:1,N:'w2:column',A:{id:'deptCd',name:'배부하는부서명',dataType:'text'}},{T:1,N:'w2:column',A:{id:'deptNm',name:'배부하는부서명',dataType:'text'}}]}]}]},{T:1,N:'xf:submission',A:{id:'sbm_master',action:'/ac.co.rsltsmgnt.distmgnt.CreateDistributionStandardAutoCMD.do',method:'post',mediatype:'application/json',ref:'data:json,[{"id":"dma_master","key":"IN_DS1"}, {"id":"ds_giveDept","key":"IN_DS2"}]',target:'',encoding:'UTF-8',instance:'',replace:'',errorHandler:'',customHandler:'',mode:'asynchronous',processMsg:'','ev:submit':'','ev:submitdone':'scwin.sbm_master_submitdone','ev:submiterror':'scwin.sbm_master_submiterror',abortTrigger:''}},{T:1,N:'w2:workflowCollection'}]},{T:1,N:'w2:layoutInfo'},{T:1,N:'script',A:{lazy:'false',type:'text/javascript'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){/**
 * 화 면 명 : 배부기준등록자동생성
 * 메뉴경로 : 회계/관리회계/실적관리/배부관리/배부부서등록
 * ASIS경로 : /debis/dongwon-debis-engine/src/main/webapp/ac/co/rsltsmgnt/distmgnt/co_405_02_02p.jsp
 * 작 성 자 : 배기원
 * 작 업 일 : 2025-12-16
 * 작업내용 :
 *    1. 화면세팅
...
scwin.f_openPopUp = function (orgObjCd, orgObjNm, select_code, flag) {
  ...
  //     // 조회조건용 수금부서 PopUp 호출
  //     case '1':
  //         var whereStr = ed_creatYmFrom.getValue().substring(0, 6) + "01,,,,givedept,1,,,," + ed_coCd.getValue();
  ...
  switch (select_code) {
    //부서코드
    case '1':
      var param = ica_creatYmFrom.getValue().substring(0, 6) + "01,,,,givedept,1,,,," + ed_coCd.getValue();
...
scwin.f_GridPop = async function (colId, row, data, close) {
  ...
  if (colId == "deptCd") {
    ...
    let param = ica_creatYmFrom.getValue().substring(0, 6) + "01,,,,givedept,1,,,," + ed_coCd.getValue();
...
scwin.f_Create = async function () {
  ...
  // 생성될 부서에 배부부서가 있을경우는 생성안됨.
  // 생성될 부서랑 배부부서가 같을 수도 있음(20060522 수정)
  //for ( var i=1; i<=ds_giveDept.CountRow; i++) {
  // if ( ed_deptCd.Text.trim() == ds_giveDept.NameValue(i,"deptCd") ) {
  // cfAlertMsg(" 기준부서가 배부부서에 들어갈 수는 없습니다. 배부부서에서 기준부서를 삭제하시기 바랍니다.");
  // return;
  // }
  //}

  //기준년월이 반영할 기간의 사이에 있는 지 체크 --20070106 (계획 배부등록시 '00'월이므로 Validation Check 제외함)
  //if ( (ed_stdYm.Text.trim() >= ed_creatYmFrom.Text.trim()) && (ed_stdYm.Text.trim() <= ed_creatYmTo.Text.trim()) ) {
  // cfAlertMsg("기준년월이 반영할 기간의 사이에 있습니다.");
  // ed_creatYmFrom.focus();
  // return;
  //}

  /* (공통에서 Validate하는 로직 있으므로 해당 내용 주석처리 (2006.02.16))
  if (((ed_stdYm.Text).substring(4,6) > "12") || ((ed_creatYmFrom.Text).substring(4,6) > "12")
  || ((ed_creatYmTo.Text).substring(4,6) > "12") )
  
  {
  cfAlertMsg(" 해당월 사용불가 합니다.");
  ed_stdYm.focus();
  return;
  }
  */
...
scwin.udc_deptCd_onviewchangeNameEvent = function (info) {
  ed_deptCd.setValue("");
  if (!$c.gus.cfIsNull($p, ed_deptNm.getValue())) {
    scwin.f_openPopUp(ed_deptCd, ed_deptNm, "1", "T");
  }
};
...
}}}]},{T:1,N:'w2:require',A:{as:'udc_topGrdBtn',type:'page',variableClone:'true',src:'/cm/udc/topGrdBtn.xml'}},{T:1,N:'w2:require',A:{as:'udc_fromToYearMon',type:'page',variableClone:'true',src:'/cm/udc/fromToYearMon.xml'}},{T:1,N:'w2:require',A:{as:'udc_comCode',type:'page',variableClone:'true',src:'/cm/udc/comCode.xml'}},{T:1,N:'w2:require',A:{as:'udc_bottomGrdBtn',type:'page',variableClone:'',src:'/cm/udc/bottomGrdBtn.xml'}}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload'},E:[{T:1,N:'xf:group',A:{class:'pop_contents',id:'',style:''},E:[{T:1,N:'w2:wframe',A:{id:'',src:'/cm/xml/contentHeader.xml',style:''}},{T:1,N:'xf:group',A:{class:'round-box',id:''},E:[{T:1,N:'xf:group',A:{id:'',class:'row-gap-8 flex_no'},E:[{T:1,N:'xf:group',A:{style:'',id:'',class:'tbbox'},E:[{T:1,N:'xf:group',A:{tagname:'table',style:'',id:'',class:'w2tb'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:summary'}]},{T:1,N:'xf:group',A:{tagname:'colgroup'},E:[{T:1,N:'xf:group',A:{tagname:'col',style:'width:120px;'}},{T:1,N:'xf:group',A:{tagname:'col',style:''}}]},{T:1,N:'xf:group',A:{tagname:'tr',style:''},E:[{T:1,N:'xf:group',A:{tagname:'th',style:'',class:'w2tb_th'},E:[{T:1,N:'w2:textbox',A:{ref:'',style:'',userData2:'',id:'',label:'회사코드',class:'req'}}]},{T:1,N:'xf:group',A:{tagname:'td',style:'',class:'w2tb_td'},E:[{T:1,N:'xf:group',A:{style:'',id:'',class:'form-group col7'},E:[{T:1,N:'w2:udc_comCode',A:{allowCharCode:'0-9',btnId:'btn_company',code:'coCd',codeId:'ed_coCd',editTypeCode:'focus','ev:onclickEvent':'scwin.udc_comCode_onclickEvent','ev:onviewchangeCodeEvent':'scwin.udc_comCode_onviewchangeCodeEvent',id:'udc_comCode',mandatoryCode:'true',maxlengthCode:'3',maxlengthName:'30',name:'coNm',nameId:'ed_coNm',objTypeCode:'data',objTypeName:'key',popupID:'popupCocd',refDataCollection:'dma_master',selectID:'retrieveDongbuGroupCompanyInfo',style:'',validExpCode:'회사코드',validTitle:'회사코드',codeWidth:'50'}}]}]}]},{T:1,N:'xf:group',A:{tagname:'tr'},E:[{T:1,N:'xf:group',A:{tagname:'th',class:'w2tb_th'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:scope',E:[{T:3,text:'row'}]}]},{T:1,N:'w2:textbox',A:{ref:'',style:'',userData2:'',id:'',label:'기준년월',class:'req'}}]},{T:1,N:'xf:group',A:{tagname:'td',class:'w2tb_td'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:colspan',E:[{T:3,text:'1'}]},{T:1,N:'w2:rowspan',E:[{T:3,text:'1'}]}]},{T:1,N:'w2:inputCalendar',A:{calendarValueType:'yearMonth',class:'w80',displayFormat:'yyyy/MM',id:'ica_stdYm',mandatory:'true',objType:'key',pickerType:'dynamic',ref:'data:dma_master.stdYm',style:''}}]}]}]}]},{T:1,N:'xf:group',A:{style:'',id:'',class:'tbbox'},E:[{T:1,N:'xf:group',A:{tagname:'table',style:'',id:'',class:'w2tb'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:summary'}]},{T:1,N:'xf:group',A:{tagname:'colgroup'},E:[{T:1,N:'xf:group',A:{tagname:'col',style:'width:120px;'}},{T:1,N:'xf:group',A:{tagname:'col',style:''}}]},{T:1,N:'xf:group',A:{tagname:'tr',style:''},E:[{T:1,N:'xf:group',A:{tagname:'th',style:'',class:'w2tb_th'},E:[{T:1,N:'w2:textbox',A:{ref:'',style:'',userData2:'',id:'',label:'생성기간',class:''}}]},{T:1,N:'xf:group',A:{tagname:'td',style:'',class:'w2tb_td'},E:[{T:1,N:'w2:udc_fromToYearMon',A:{edFromId:'ica_creatYmFrom',edToId:'ica_creatYmTo',id:'udc_fromToYearMon',mandatoryFrom:'true',mandatoryTo:'true',refDataMap:'dma_master',refEdDt:'creatYmTo',refStDt:'creatYmFrom',style:'',titleFrom:'생성기간',titleTo:'생성기간'}}]}]},{T:1,N:'xf:group',A:{tagname:'tr'},E:[{T:1,N:'xf:group',A:{tagname:'th',class:'w2tb_th'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:scope',E:[{T:3,text:'row'}]}]},{T:1,N:'w2:textbox',A:{ref:'',style:'',userData2:'',id:'',label:'기준부서',class:''}}]},{T:1,N:'xf:group',A:{tagname:'td',class:'w2tb_td'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:colspan',E:[{T:3,text:'1'}]},{T:1,N:'w2:rowspan',E:[{T:3,text:'1'}]}]},{T:1,N:'w2:udc_comCode',A:{allowCharCode:'0-9',btnId:'btn_deptCd',code:'distAcctDeptCd',codeId:'ed_deptCd',editTypeCode:'focus','ev:onclickEvent':'scwin.udc_deptCd_onclickEvent','ev:onviewchangeCodeEvent':'scwin.udc_deptCd_onviewchangeCodeEvent',id:'udc_deptCd',mandatoryCode:'',maxlengthCode:'5',maxlengthName:'30',name:'distAcctDeptNm',nameId:'ed_deptNm',objTypeCode:'data',objTypeName:'key',popupID:'popup_deptCd',refDataCollection:'dma_master',selectID:'retrieveAcctDeptCdInfo',style:'',validExpCode:'부서',validTitle:'부서','ev:onviewchangeNameEvent':'scwin.udc_deptCd_onviewchangeNameEvent'}}]}]}]}]}]},{T:1,N:'xf:group',A:{class:' row-gap-8',id:''},E:[{T:1,N:'xf:group',A:{class:'title-wrap',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'title',id:''},E:[{T:1,N:'w2:textbox',A:{class:'tit',id:'',label:'배부부서',style:'',tagname:'h3'}}]},{T:1,N:'xf:group',A:{class:'right',id:''},E:[{T:1,N:'w2:udc_topGrdBtn',A:{grdDownOpts:'{"fileName":"배부부서.xlsx", "sheetName":"배부부서", "type":"1"}',gridID:'gr_giveDept',gridUpYn:'N',grp:'grd_section1',id:'udc_excel',style:'',templateYn:'N'}}]}]},{T:1,N:'xf:group',A:{adaptiveThreshold:'',class:'gvwbox',id:'grd_section1',style:''},E:[{T:1,N:'w2:gridView',A:{autoFit:'lastColumn',checkReadOnlyOnPasteEnable:'',class:'wq_gvw',dataList:'data:ds_giveDept',focusMode:'cell',id:'gr_giveDept',scrollByColumn:'false',scrollByColumnAdaptive:'false',style:'',visibleRowNum:'15',visibleRowNumFix:'true',enterKeyMove:'editRight',rowStatusVisible:'true',rowStatusWidth:'20',readOnly:'true','ev:onafteredit':'scwin.gr_giveDept_onafteredit','ev:oncellclick':'scwin.gr_giveDept_oncellclick','ev:ontextimageclick':'scwin.gr_giveDept_ontextimageclick','ev:onbeforeedit':'scwin.gr_giveDept_onbeforeedit',keepDefaultColumnWidth:'true'},E:[{T:1,N:'w2:caption',A:{id:'caption10',style:'',value:'this is a grid caption.'}},{T:1,N:'w2:header',A:{id:'header2',style:''},E:[{T:1,N:'w2:row',A:{id:'row3',style:''},E:[{T:1,N:'w2:column',A:{blockSelect:'false',displayMode:'label',id:'column12',inputType:'text',removeBorderStyle:'false',width:'120',value:'배부부서'}},{T:1,N:'w2:column',A:{blockSelect:'false',displayMode:'label',id:'column11',inputType:'text',removeBorderStyle:'false',width:'300',value:'부서명'}}]}]},{T:1,N:'w2:gBody',A:{id:'gBody2',style:''},E:[{T:1,N:'w2:row',A:{id:'row4',style:''},E:[{T:1,N:'w2:column',A:{blockSelect:'false',displayMode:'label',id:'deptCd',inputType:'textImage',removeBorderStyle:'false',width:'120',editFormat:'#####',dataType:'number',mandatory:'true',validateOnInput:'true',readOnly:'false'}},{T:1,N:'w2:column',A:{blockSelect:'false',displayMode:'label',id:'deptNm',inputType:'text',removeBorderStyle:'false',width:'300',textAlign:'left',mandatory:'true'}}]}]}]},{T:1,N:'xf:group',A:{class:'grid-bottom ',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'left',id:''},E:[{T:1,N:'xf:group',A:{class:'grid-total',id:''},E:[{T:1,N:'w2:textbox',A:{class:'',id:'',label:'총',style:'',tagname:'span'}},{T:1,N:'w2:textbox',A:{class:'num',dataType:'number',displayFormat:'#,##0',id:'totalRows',label:'0',style:'',tagname:'span'}},{T:1,N:'w2:textbox',A:{class:'',id:'',label:'건',style:'',tagname:'span'}},{T:1,N:'w2:udc_comCode',A:{popupID:'',selectID:'',codeId:'',validTitle:'',nameId:'',style:'width:%; height:px; ;visibility:hidden;',id:'udc_comCode_Grid'}}]}]},{T:1,N:'xf:group',A:{class:'right',id:'',style:''},E:[{T:1,N:'w2:udc_bottomGrdBtn',A:{btnCancelObj:'btn_cancel',btnCancelYn:'Y',btnDelYn:'N',btnRowAddObj:'btn_rowAdd',btnRowDelObj:'btn_rowDel',btnRowDelYn:'Y',gridID:'gr_giveDept',rowAddFunction:'scwin.f_AddRowRegion',style:'',cancelFunction:'scwin.f_Cancel',rowDelFunction:'scwin.f_Delete',rowAddUserAuth:'C',rowDelUserAuth:'D'}}]}]}]}]}]},{T:1,N:'xf:group',A:{class:'pop-btnbox',id:'',style:''},E:[{T:1,N:'xf:trigger',A:{class:'btn','ev:onclick':'scwin.f_Create',id:'btn_create',objType:'bSave',style:'',type:'button',userAuth:'U'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'생성'}]}]},{T:1,N:'xf:trigger',A:{class:'btn','ev:onclick':'scwin.f_WinClose',id:'btn_close',style:'',type:'button'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'닫기'}]}]}]}]}]}]}]})