...
scwin.f_Save = async function () {
  try {
    ...
    */
    ...
    if (await $c.win.confirm($p, $c.data.getMessage($p, MSG_CM_CRM_009, "전자결제파일생성-하나은행"))) {
      ds_cont.removeAll();
      sbm_save.action = "/ac.fm.paymgnt.paymgnt.CreateHnbFileCMD.do";
...
scwin.sbm_save_submitdone = function (e) {
  try {
    ...
    if (ds_cont.getRowCount() > 0) {
      scwin.f_createFile();
      $c.gus.cfAlertMsg($p, $c.data.getMessage($p, MSG_CM_INF_012, "전자결제파일생성-하나은행"));
    } else {
...
scwin.f_createFile = function () {
  // 파일제목생성
  let title = "(하나)" + $c.date.getServerDateTime($p, "yyyyMMdd");
  const options = {
    fileName: title + ".xlsx",
...
}}}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload'},E:[{T:1,N:'xf:group',A:{class:'sub_contents',id:'',style:''},E:[{T:1,N:'w2:wframe',A:{id:'',src:'/cm/xml/contentHeader.xml',style:''}},{T:1,N:'xf:group',A:{id:'',class:'round-box'},E:[{T:1,N:'xf:group',A:{style:'',id:'',class:'tbbox'},E:[{T:1,N:'xf:group',A:{tagname:'table',style:'',id:'',class:'w2tb'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:summary'}]},{T:1,N:'xf:group',A:{tagname:'colgroup'},E:[{T:1,N:'xf:group',A:{tagname:'col',style:'width:120px;'}},{T:1,N:'xf:group',A:{tagname:'col',style:''}}]},{T:1,N:'xf:group',A:{tagname:'tr',style:''},E:[{T:1,N:'xf:group',A:{tagname:'th',style:'',class:'w2tb_th'},E:[{T:1,N:'w2:textbox',A:{ref:'',style:'',userData2:'',id:'',label:'지급일자',class:'req'}}]},{T:1,N:'xf:group',A:{tagname:'td',style:'',class:'w2tb_td'},E:[{T:1,N:'w2:inputCalendar',A:{style:'',id:'ed_dcsnDt',class:'',calendarValueType:'yearMonthDate',mandatory:'true',objType:'data',title:'지급일자',ref:'data:ds_electronic.dcsnDt',displayFormat:'yyyy/MM/dd'}}]}]}]}]},{T:1,N:'xf:group',A:{style:'',id:'',class:'btnbox'},E:[{T:1,N:'xf:group',A:{style:'',id:'',class:'right'},E:[{T:1,N:'xf:trigger',A:{class:'btn',id:'btn_Save',style:'',type:'button',userAuth:'U','ev:onclick':'scwin.f_Save'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'생성'}]}]}]}]},{T:1,N:'w2:gridView',A:{autoFit:'allColumn',checkReadOnlyOnPasteEnable:'',class:'wq_gvw',columnMove:'true',dataList:'data:ds_cont',id:'gr_file',readOnly:'true',style:';display:none;'},E:[{T:1,N:'w2:caption',A:{id:'caption2',style:'',value:'this is a grid caption.'}},{T:1,N:'w2:header',A:{id:'header2',style:''},E:[{T:1,N:'w2:row',A:{id:'row3',style:''},E:[{T:1,N:'w2:column',A:{displayMode:'label',id:'clntNm',inputType:'text',style:'',value:'거래처',width:'200'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'crn',inputType:'text',style:'',value:'거래처사업자번호',width:'200'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'payAmt',inputType:'text',style:'',value:'금액',width:'200'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'dueDt',inputType:'text',style:'',value:'만기일자',width:'200'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'bnkClntNo',inputType:'text',style:'',value:'거래처등록번호',width:'200'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'taxinvcDt',inputType:'text',style:'',value:'세금계산서일자',width:'200'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'taxAmt',inputType:'text',style:'',value:'세금계산서금액',width:'200'}}]}]},{T:1,N:'w2:gBody',A:{id:'gBody2',style:''},E:[{T:1,N:'w2:row',A:{id:'row4',style:''},E:[{T:1,N:'w2:column',A:{displayMode:'label',id:'clntNm',inputType:'text',text:'',textAlign:'left',value:'',width:'200'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'crn',inputType:'text',text:'',textAlign:'left',value:'',width:'200'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'payAmt',inputType:'text',text:'',textAlign:'left',value:'',width:'200',displayFormat:'#,##0'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'dueDt',inputType:'text',text:'',textAlign:'left',value:'',width:'200'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'bnkClntNo',inputType:'text',text:'',textAlign:'left',value:'',width:'200'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'taxinvcDt',inputType:'text',text:'',textAlign:'left',value:'',width:'200'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'taxAmt',inputType:'text',text:'',textAlign:'left',value:'',width:'200',displayFormat:'#,##0'}}]}]}]}]}]}]}]}]})