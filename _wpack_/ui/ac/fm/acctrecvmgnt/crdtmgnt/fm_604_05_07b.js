/*amd /ui/ac/fm/acctrecvmgnt/crdtmgnt/fm_604_05_07b.xml 28707 a319fd8046423c765125f3cc52e13a1a735b2b915e148baa3d961290bf67afb8 */
define({declaration:{A:{version:'1.0',encoding:'UTF-8'}},E:[{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',E:[{T:1,N:'w2:type',E:[{T:3,text:'COMPONENT'}]},{T:1,N:'w2:buildDate'},{T:1,N:'w2:MSA'},{T:1,N:'xf:model',E:[{T:1,N:'w2:dataCollection',A:{baseNode:'map'},E:[{T:1,N:'w2:dataList',A:{baseNode:'list',repeatNode:'map',id:'ds_etcCreditInfo',saveRemovedData:'true'},E:[{T:1,N:'w2:columnInfo',E:[{T:1,N:'w2:column',A:{id:'num',name:'등록년도',dataType:''}},{T:1,N:'w2:column',A:{id:'crn',name:'사업자번호',dataType:'text'}},{T:1,N:'w2:column',A:{id:'crnNm',name:'법인명',dataType:'text'}},{T:1,N:'w2:column',A:{id:'deposit',name:'보증금액',dataType:'number'}},{T:1,N:'w2:column',A:{id:'stCtrtDt',name:'계약시작일',dataType:'text'}},{T:1,N:'w2:column',A:{id:'endCtrtDt',name:'계약종료일',dataType:'text'}},{T:1,N:'w2:column',A:{id:'grtDocNo',name:'보증서번호',dataType:'text'}},{T:1,N:'w2:column',A:{id:'rmk',name:'비고',dataType:'text'}},{T:1,N:'w2:column',A:{id:'gbn',name:'구분',dataType:'text'}},{T:1,N:'w2:column',A:{id:'tmnYn',name:'해지여부',dataType:'number'}},{T:1,N:'w2:column',A:{id:'tmnDt',name:'해지일자',dataType:'text'}},{T:1,N:'w2:column',A:{id:'pldgPattern',name:'',dataType:'text'}},{T:1,N:'w2:column',A:{id:'regDept',name:'등록부서',dataType:'text'}},{T:1,N:'w2:column',A:{id:'regId',name:'등록자',dataType:'text'}},{T:1,N:'w2:column',A:{id:'grtInst',name:'보증기관',dataType:'text'}},{T:1,N:'w2:column',A:{id:'regDeptNm',name:'name16',dataType:'text'}},{T:1,N:'w2:column',A:{id:'empNm',name:'name17',dataType:'text'}},{T:1,N:'w2:column',A:{id:'pldgNo',name:'name18',dataType:'text'}},{T:1,N:'w2:column',A:{id:'regDtm',name:'name19',dataType:'text'}}]}]},{T:1,N:'w2:dataMap',A:{baseNode:'map',id:'dma_etcCreditInfoSearch'},E:[{T:1,N:'w2:keyInfo',E:[{T:1,N:'w2:key',A:{id:'pldgNo',name:'name1',dataType:'text'}}]}]},{T:1,N:'w2:aliasDataList',A:{id:'p_ds_pldgNo',scope:'../ds_pldgNo',style:''}}]},{T:1,N:'w2:workflowCollection'},{T:1,N:'xf:submission',A:{id:'sbm_retrieve',action:'',method:'post',mediatype:'application/json',ref:'data:json,[{"id":"dma_etcCreditInfoSearch","key":"IN_DS1"},{"id":"ds_etcCreditInfo","key":"OUT_DS1"}]',target:'data:json,{"id":"ds_etcCreditInfo","key":"OUT_DS1"}',encoding:'UTF-8',instance:'',replace:'',errorHandler:'',customHandler:'',mode:'asynchronous',processMsg:'','ev:submit':'','ev:submitdone':'scwin.sbm_retrieve_submitdone','ev:submiterror':'',abortTrigger:''}},{T:1,N:'xf:submission',A:{id:'sbm_save',action:'/ac.fm.acctrecvmgnt.crdtmgnt.SaveEtcCreditCMD.do',method:'post',mediatype:'application/json',ref:'data:json,{"action":"modified","id":"ds_etcCreditInfo","key":"IN_DS1"}',target:'',encoding:'UTF-8',instance:'',replace:'',errorHandler:'',customHandler:'',mode:'asynchronous',processMsg:'','ev:submit':'','ev:submitdone':'scwin.sbm_save_submitdone','ev:submiterror':'',abortTrigger:''}}]},{T:1,N:'w2:layoutInfo'},{T:1,N:'w2:publicInfo',A:{method:''}},{T:1,N:'script',A:{lazy:'false',type:'text/javascript'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){//전역변수
...
scwin.onpageload = function () {
  ds_etcCreditInfo.insertRow(0);
  ds_etcCreditInfo.setRowPosition(0);
  lc_tmnYn.setValue("0");
};
scwin.onUdcCompleted = function () {
  if (scwin.pldgNo != "") {
    scwin.setPldgNo(scwin.pldgNo);
    ds_etcCreditInfo.setCellData(0, "pldgNo", scwin.pldgNo);
  }
...
scwin.setPldgNo = function (pldgNo) {
  ds_etcCreditInfo.setCellData(0, "pldgNo", pldgNo);
  dma_etcCreditInfoSearch.set("pldgNo", pldgNo);

  //alert(hid_pldgNo.getValue());
  sbm_retrieve.action = "/ac.fm.acctrecvmgnt.crdtmgnt.RetrieveEtcCreditListCMD.do";
...
scwin.fn_Create = function () {
  ds_etcCreditInfo.setCellData(0, "pldgNo", "");
  ds_etcCreditInfo.modifyRowStatus(0, "C");
  ed_crn.options.hidVal = "";
  ed_busiNm.options.hidVal = "";
  ed_regDept.options.hidVal = "";
  ed_regDeptNm.options.hidVal = "";
...
scwin.fn_Update = function () {
  ...
  $c.gus.cfEnableObjects($p, [table3]);
...
scwin.f_Save = async function () {
  ...
  //변경한 데이터가 있는지 체크한다. 
  if (ds_etcCreditInfo.getModifiedIndex().length == 0 && p_ds_pldgNo.getModifiedIndex().length == 0) {
  ...
  if (scwin.globalCreateYn == 0) {
    ...
    ds_etcCreditInfo.setCellData(ds_etcCreditInfo.getRowPosition(), 'tmnYnOrg', p_ds_pldgNo.getCellData(p_ds_pldgNo.getRowPosition(), "tmnYn"));
    if (p_ds_pldgNo.getCellData(p_ds_pldgNo.getRowPosition(), "tmnYn") == ds_etcCreditInfo.getCellData(ds_etcCreditInfo.getRowPosition(), 'tmnYn') && ds_etcCreditInfo.getCellData(ds_etcCreditInfo.getRowPosition(), 'tmnYn') == 1) {
      creditLimit = parseFloat(p_ds_pldgNo.getCellData(p_ds_pldgNo.getRowPosition(), "crdtLimit"));
      scwin.hid_creditLimit = creditLimit;
    } else if (p_ds_pldgNo.getCellData(p_ds_pldgNo.getRowPosition(), "tmnYn") == ds_etcCreditInfo.getCellData(ds_etcCreditInfo.getRowPosition(), 'tmnYn') && ds_etcCreditInfo.getCellData(ds_etcCreditInfo.getRowPosition(), 'tmnYn') == 0) {
      creditLimit = parseFloat(p_ds_pldgNo.getCellData(p_ds_pldgNo.getRowPosition(), "crdtLimit"));
      scwin.hid_creditLimit = creditLimit;
    } else if (p_ds_pldgNo.getCellData(p_ds_pldgNo.getRowPosition(), 'tmnYn') != ds_etcCreditInfo.getCellData(ds_etcCreditInfo.getRowPosition(), 'tmnYn') && ds_etcCreditInfo.getCellData(ds_etcCreditInfo.getRowPosition(), 'tmnYn') == 1) {
  ...
  if ((await $c.win.confirm($p, MSG_CM_CRM_001)) == true) {
    ds_etcCreditInfo.setCellData(ds_etcCreditInfo.getRowPosition(), 'pldgPattern', "05");
...
scwin.sbm_retrieve_submitdone = async function (e) {
  ...
  ds_etcCreditInfo.setRowPosition(0);
  if (lc_tmnYn.getValue() == "1") {
    $c.gus.cfDisableObjects($p, [table3]);
    $c.gus.cfDisableBtnOnly($p, [btnUpdate]);
  } else {
    // $c.gus.cfEnableBtnOnly([btnUpdate]);
    // $c.gus.cfDisableObjects([ica_regDtm, ed_crn, ed_busiNm, ed_regDept, ed_regDeptNm, ed_regId, ed_empNm])
  }
  let rowCnt = ds_etcCreditInfo.getRowCount();
  if (rowCnt == 0) {
  ...
  let value = ds_etcCreditInfo.getCellData(0, "regId");
  if (value && !/^\d{1,8}$/.test(value)) {
    ds_etcCreditInfo.setCellData(0, "regId", "");
  }
  data = ds_etcCreditInfo.getCellData(0, "regDtm");
  if (data.length > 10) {
    ds_etcCreditInfo.setCellData(0, "regDtm", data.substring(0, 10).replace(/-/g, ""));
  }
};
...
}}}]},{T:1,N:'w2:require',A:{as:'udc_comCode',type:'page',variableClone:'true',src:'/cm/udc/comCode.xml'}}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload'},E:[{T:1,N:'xf:group',A:{class:'tbbox',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'w2tb',id:'table3',style:'',tagname:'table'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:summary'}]},{T:1,N:'xf:group',A:{tagname:'colgroup'},E:[{T:1,N:'xf:group',A:{style:'width:120px;',tagname:'col'}},{T:1,N:'xf:group',A:{tagname:'col'}},{T:1,N:'xf:group',A:{style:'width: 120px;',tagname:'col'}},{T:1,N:'xf:group',A:{tagname:'col'}},{T:1,N:'xf:group',A:{style:'width: 120px;',tagname:'col'}},{T:1,N:'xf:group',A:{tagname:'col'}},{T:1,N:'xf:group',A:{style:'width: 120px;',tagname:'col'}},{T:1,N:'xf:group',A:{style:'',tagname:'col'}}]},{T:1,N:'xf:group',A:{style:'',tagname:'tr'},E:[{T:1,N:'xf:group',A:{class:'w2tb_th',style:'',tagname:'th'},E:[{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'사업자번호',ref:'',style:'',userData2:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',style:'',tagname:'td'},E:[{T:1,N:'w2:udc_comCode',A:{allowCharCode:'0-9',code:'crn',codeId:'ed_crn','ev:onblurCodeEvent':'scwin.udc_creditCrnInfo_onblurCodeEvent','ev:onblurNameEvent':'scwin.udc_creditCrnInfo_onblurNameEvent','ev:onclickEvent':'scwin.udc_creditCrnInfo_onclickEvent',id:'udc_creditCrnInfo',mandatoryCode:'true',maxlengthCode:'13',maxlengthName:'20',name:'crnNm',nameId:'ed_busiNm',objTypeCode:'key',objTypeName:'key',popupID:'',refDataCollection:'ds_etcCreditInfo',selectID:'retrieveCreditCrnInfo',style:'',validExpCode:'사업자번호:yes:maxLength=13&number',validTitle:'사업자번호',skipOnBlurCodeValueEmpty:'N',skipOnBlurNameValueEmpty:'N'}}]},{T:1,N:'xf:group',A:{class:'w2tb_th',tagname:'th'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'등록일자',ref:'',style:'',userData2:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',tagname:'td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:inputCalendar',A:{calendarValueType:'yearMonthDate',class:'',displayFormat:'yyyy/MM/dd','ev:onblur':'scwin.ica_regDtm_onblur',id:'ica_regDtm',mandatory:'true',objType:'key',ref:'data:ds_etcCreditInfo.regDtm',style:'',title:'등록일자'}}]},{T:1,N:'xf:group',A:{class:'w2tb_th',tagname:'th'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:textbox',A:{class:'',id:'',label:'보증기관',ref:'',style:'',userData2:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',tagname:'td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'xf:input',A:{class:'',id:'ed_grtInst',objType:'data',ref:'data:ds_etcCreditInfo.grtInst',style:'width: 200px;'}}]},{T:1,N:'xf:group',A:{class:'w2tb_th',tagname:'th'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:textbox',A:{class:'',id:'',label:'보증서번호',ref:'',style:'',userData2:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',tagname:'td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'xf:input',A:{allowChar:'0-9',class:'tar',id:'ed_grtDocNo',maxlength:'20',objType:'data',ref:'data:ds_etcCreditInfo.grtDocNo',style:'width: 200px;',title:'보증서번호'}}]}]},{T:1,N:'xf:group',A:{tagname:'tr'},E:[{T:1,N:'xf:group',A:{class:'w2tb_th',tagname:'th'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:scope',E:[{T:3,text:'row'}]}]},{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'등록부서 ',ref:'',style:'',userData2:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',tagname:'td'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:colspan',E:[{T:3,text:'1'}]},{T:1,N:'w2:rowspan',E:[{T:3,text:'1'}]}]},{T:1,N:'w2:udc_comCode',A:{allowCharCode:'0-9',code:'regDept',codeId:'ed_regDept','ev:onblurCodeEvent':'scwin.udc_acctDeptCdInfo_onblurCodeEvent','ev:onblurNameEvent':'scwin.udc_acctDeptCdInfo_onblurNameEvent','ev:onclickEvent':'scwin.udc_acctDeptCdInfo_onclickEvent',id:'udc_acctDeptCdInfo',mandatoryCode:'true',maxlengthCode:'5',maxlengthName:'50',name:'regDeptNm',nameId:'ed_regDeptNm',objTypeCode:'key',objTypeName:'key',popupID:'',refDataCollection:'ds_etcCreditInfo',selectID:'retrieveAcctDeptCdInfo',style:'',validTitle:'등록부서',skipOnBlurCodeValueEmpty:'N',skipOnBlurNameValueEmpty:'N'}}]},{T:1,N:'xf:group',A:{class:'w2tb_th',tagname:'th'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'보증금액',ref:'',style:'',userData2:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',tagname:'td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'xf:input',A:{allowChar:'0-9',class:'tar',dataType:'number',displayFormat:'#,##0','ev:onblur':'scwin.ed_deposit_onblur',id:'ed_deposit',mandatory:'true',maxlength:'13',objType:'data',ref:'data:ds_etcCreditInfo.deposit',style:'width: 200px;',title:'보증금액'}}]},{T:1,N:'xf:group',A:{class:'w2tb_th',tagname:'th'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'계약기간From',ref:'',style:'',userData2:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',tagname:'td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:inputCalendar',A:{calendarValueType:'yearMonthDate',class:'',displayFormat:'yyyy/MM/dd',id:'ica_stCtrtDt',mandatory:'true',objType:'data',ref:'data:ds_etcCreditInfo.stCtrtDt',style:'',title:'계약기간From'}}]},{T:1,N:'xf:group',A:{class:'w2tb_th',tagname:'th'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'계약기간To',ref:'',style:'',userData2:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',tagname:'td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:inputCalendar',A:{calendarValueType:'yearMonthDate',class:'',displayFormat:'yyyy/MM/dd',id:'ica_endCtrtDt',mandatory:'true',objType:'data',ref:'data:ds_etcCreditInfo.endCtrtDt',style:'',title:'계약기간To'}}]}]},{T:1,N:'xf:group',A:{tagname:'tr'},E:[{T:1,N:'xf:group',A:{class:'w2tb_th',tagname:'th'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:scope',E:[{T:3,text:'row'}]}]},{T:1,N:'w2:textbox',A:{class:'',id:'',label:'등록자',ref:'',style:'',userData2:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',tagname:'td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:udc_comCode',A:{allowCharCode:'0-9',code:'regId',codeId:'ed_regId','ev:onblurCodeEvent':'scwin.udc_empDeptClntInfo_onblurCodeEvent','ev:onblurNameEvent':'scwin.udc_empDeptClntInfo_onblurNameEvent','ev:onclickEvent':'scwin.udc_empDeptClntInfo_onclickEvent',id:'udc_empDeptClntInfo',maxlengthCode:'8',maxlengthName:'50',name:'empNm',nameId:'ed_empNm',objTypeCode:'key',objTypeName:'key',popupID:'',refDataCollection:'ds_etcCreditInfo',selectID:'retrieveEmpDeptClntInfo',style:'',validTitle:'',skipOnBlurCodeValueEmpty:'N',skipOnBlurNameValueEmpty:'N'}}]},{T:1,N:'xf:group',A:{class:'w2tb_th',tagname:'th'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:textbox',A:{class:'',id:'',label:'해지여부',ref:'',style:'',userData2:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',tagname:'td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'xf:select1',A:{allOption:'',appearance:'minimal',class:'',direction:'auto',disabled:'false',disabledClass:'w2selectbox_disabled','ev:onblur':'scwin.lc_tmnYn_onblur','ev:onchange':'scwin.lc_tmnYn_onchange',id:'lc_tmnYn',objType:'data',ref:'data:ds_etcCreditInfo.tmnYn',style:'width: 150px',submenuSize:'fixed'},E:[{T:1,N:'xf:choices',E:[{T:1,N:'xf:item',E:[{T:1,N:'xf:label',E:[{T:4,cdata:'예'}]},{T:1,N:'xf:value',E:[{T:4,cdata:'1'}]}]},{T:1,N:'xf:item',E:[{T:1,N:'xf:label',E:[{T:4,cdata:'아니오'}]},{T:1,N:'xf:value',E:[{T:4,cdata:'0'}]}]}]}]}]},{T:1,N:'xf:group',A:{class:'w2tb_th',tagname:'th'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:textbox',A:{class:'',id:'',label:'해지일자',ref:'',style:'',userData2:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',tagname:'td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:inputCalendar',A:{calendarValueType:'yearMonthDate',class:'',displayFormat:'yyyy/MM/dd',id:'ica_tmnDt',objType:'data',ref:'data:ds_etcCreditInfo.tmnDt',style:'',title:'해지일자',mandatory:'true'}}]},{T:1,N:'xf:group',A:{class:'w2tb_th',tagname:'th'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:textbox',A:{class:'',id:'',label:'구분',ref:'',style:'',userData2:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',tagname:'td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'xf:select1',A:{allOption:'',appearance:'minimal',chooseOption:'',class:'',direction:'auto',disabled:'false',disabledClass:'w2selectbox_disabled',displayMode:'label',id:'lc_gbn',objType:'data',ref:'data:ds_etcCreditInfo.gbn',style:'width: 150px;',submenuSize:'fixed',emptyItem:'true'},E:[{T:1,N:'xf:choices',E:[{T:1,N:'xf:item',E:[{T:1,N:'xf:label',E:[{T:4,cdata:'개별한도'}]},{T:1,N:'xf:value',E:[{T:4,cdata:'1'}]}]},{T:1,N:'xf:item',E:[{T:1,N:'xf:label',E:[{T:4,cdata:'자유한도'}]},{T:1,N:'xf:value',E:[{T:4,cdata:'2'}]}]}]}]}]}]}]}]},{T:1,N:'xf:group',A:{class:'btnbox',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'right',id:''},E:[{T:1,N:'xf:trigger',A:{class:'btn',id:'btnCreate',style:'',type:'button','ev:onclick':'scwin.fn_Create'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'입력'}]}]},{T:1,N:'xf:trigger',A:{class:'btn',id:'btnUpdate',style:'',type:'button','ev:onclick':'scwin.fn_Update'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'수정'}]}]},{T:1,N:'xf:trigger',A:{class:'btn',id:'btn_save',style:'',type:'button','ev:onclick':'scwin.f_Save'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'저장'}]}]}]}]}]}]}]})