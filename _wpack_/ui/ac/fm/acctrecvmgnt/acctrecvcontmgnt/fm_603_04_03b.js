...
scwin.ondataload = function () {
  try {
    ...
    if (scwin.sChkUser == "1") {
      ...
      acb_acctCd.setValue(ACConstants.ACCTCD_DCAMT_PNLTY);
    }
...
scwin.udc_coCd_callBackFunc = function (ret) {
  try {
    ...
    ds_searchAcctRecv.set("profitGbn", "1");
  } catch (e) {
...
scwin.f_Save = async function (e) {
  try {
    ...
    //귀속부서 및 거래처가 변경되었을 경우 재조회 후 잡이익 처리가 가능한게 함.
    if (scwin.hid_acctDeptCd.trim() == "" || scwin.hid_acctDeptCd != ed_sacctDeptCd.getValue().trim()) {
      $c.gus.cfAlertMsg($p, "청구(수금)부서가 변경되어 잡이익 처리가 불가능합니다. 재조회후 처리 하시기 바랍니다.");
      return false;
    }
    if (scwin.hid_clntNo.trim() == "" || scwin.hid_clntNo != ed_sclntNo.getValue().trim()) {
      $c.gus.cfAlertMsg($p, "거래처가 변경되어 잡이익 처리가 불가능합니다. 재조회후 처리 하시기 바랍니다.");
      return false;
    }
    ...
    for (i = 0; i < ds_acctRecv.getRowCount(); i++) {
      ...
      if (ds_acctRecv.getCellData(i, "num") == "T") {
        ramt = Number(ramt) + Number(ds_acctRecv.getCellData(i, "ramt"));
      }
    }
    if (scwin.gJudgeYn == "0" && ramt < -10000) {
      $c.gus.cfAlertMsg($p, "잡이익등록은   10000이상 초과 할 수 없습니다 .");
      return false;
    }
    if (await $c.win.confirm($p, MSG_CM_CRM_001)) {
      //ASIS 추가수금내역 Data Bind
      ds_addAcctRecvEtcProfit.insertRow(0);
      ds_addAcctRecvEtcProfit.setCellData(0, "wrkDt", ed_wrkDt.getValue()); //작업일자
      ds_addAcctRecvEtcProfit.setCellData(0, "acctCd", acb_acctCd.getValue()); //계정코드
      ds_addAcctRecvEtcProfit.setCellData(0, "queryDeptSearchStDate", ed_FromDate.getValue()); //시작일자(부서검색시 이용되는 조건)
      ds_addAcctRecvEtcProfit.setCellData(0, "queryDeptSearchEndDate", ed_ToDate.getValue()); //종료일자(부서검색시 이용되는 조건)
...
// 저장 콜백
//-------------------------------------------------------------------------
scwin.sbm_saveAcctRecvEtcProfit_submitdone = function (e) {
  try {
    if (e.responseJSON.resultDataSet[0].Code < 0) return; //onFail
    $c.gus.cfAlertMsg($p, MSG_CM_INF_001);
    scwin.f_Retrieve();
  } catch (e) {
    console.log("sbm_saveAcctRecvEtcProfit_submitdone : " + e);
  }
};
}}}]},{T:1,N:'w2:require',A:{as:'udc_topGrdBtn',type:'page',variableClone:'true',src:'/cm/udc/topGrdBtn.xml'}},{T:1,N:'w2:require',A:{as:'udc_comCode',type:'page',variableClone:'true',src:'/cm/udc/comCode.xml'}},{T:1,N:'w2:require',A:{as:'udc_fromToCalendar',type:'page',variableClone:'true',src:'/cm/udc/fromToCalendar.xml'}}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload'},E:[{T:1,N:'xf:group',A:{class:'round-box',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'shbox',id:'table1',style:''},E:[{T:1,N:'xf:group',A:{class:'shbox-inner',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'w2tb ',id:'',style:'',tagname:'table'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:summary'}]},{T:1,N:'xf:group',A:{tagname:'colgroup'},E:[{T:1,N:'xf:group',A:{style:'width:70px;',tagname:'col'}},{T:1,N:'xf:group',A:{style:'',tagname:'col'}},{T:1,N:'xf:group',A:{style:'width:105px;',tagname:'col'}},{T:1,N:'xf:group',A:{style:'',tagname:'col'}}]},{T:1,N:'xf:group',A:{class:'',id:'',style:'',tagname:'tr'},E:[{T:1,N:'xf:group',A:{class:'w2tb_th ',style:'',tagname:'th'},E:[{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'거래처 ',style:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',style:'',tagname:'td'},E:[{T:1,N:'w2:udc_comCode',A:{class:'',popupID:'',style:'',codeId:'ed_sclntNo',validExpCode:'',UpperFlagCode:'1',allowCharCode:'0-9',maxlengthCode:'6',editTypeCode:'select',nameId:'ed_sclntNm',id:'udc_clntNo',editTypeName:'select',maxlengthName:'50',refDataCollection:'ds_searchAcctRecv',code:'clntNo',selectID:'retrieveClntEmpNoList','ev:onblurCodeEvent':'scwin.udc_clntNo_onblurCodeEvent','ev:onclickEvent':'scwin.udc_clntNo_onclickEvent','ev:onblurNameEvent':'scwin.udc_clntNo_onblurNameEvent',validTitle:'거래처',objTypeCode:'data',objTypeName:'data',mandatoryCode:'true',skipOnBlurCodeValueEmpty:'N',skipOnBlurNameValueEmpty:'N'}}]},{T:1,N:'xf:group',A:{class:'w2tb_th',style:'',tagname:'th'},E:[{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'청구일자 ',style:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',id:'',style:'',tagname:'td'},E:[{T:1,N:'w2:udc_fromToCalendar',A:{id:'',refDataMap:'ds_searchAcctRecv',refEdDt:'bilgToDate',refStDt:'bilgFromDate',style:'',edFromId:'ed_FromDate',mandatoryFrom:'true',mandatoryTo:'true',edToId:'ed_ToDate',objTypeTo:'data',objTypeFrom:'data'}}]}]},{T:1,N:'xf:group',A:{id:'',tagname:'tr'},E:[{T:1,N:'xf:group',A:{class:'w2tb_th ',tagname:'th'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:scope',E:[{T:3,text:'row'}]}]},{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'회사코드 ',style:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',tagname:'td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:udc_comCode',A:{popupID:'',style:'width:250px;',class:'',codeId:'ed_coCd',nameId:'ed_coNm',btnId:'btn_company',objTypeName:'data',mandatoryCode:'true',objTypeCode:'data',UpperFlagCode:'1',allowCharCode:'0-9',maxlengthCode:'3',id:'udc_coCd',refDataCollection:'ds_searchAcctRecv',code:'coCd',validTitle:'회사코드',selectID:'retrieveDongbuGroupCompanyInfo','ev:onblurCodeEvent':'scwin.udc_coCd_onblurCodeEvent','ev:onclickEvent':'scwin.udc_coCd_onclickEvent'}}]},{T:1,N:'xf:group',A:{class:'w2tb_th',tagname:'th'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:scope',E:[{T:3,text:'row'}]}]},{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'청구부서 ',style:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',id:'',tagname:'td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:udc_comCode',A:{class:'',popupID:'',style:'',codeId:'ed_sacctDeptCd',nameId:'ed_sacctDeptNm',maxlengthCode:'5',allowCharCode:'0-9',code:'acctDeptCd',refDataCollection:'ds_searchAcctRecv',selectID:'retrieveAcctDeptCdInfo6',id:'udc_acctDeptCd',validTitle:'청구부서','ev:onblurCodeEvent':'scwin.udc_acctDeptCd_onblurCodeEvent','ev:onclickEvent':'scwin.udc_acctDeptCd_onclickEvent','ev:onblurNameEvent':'scwin.udc_acctDeptCd_onblurNameEvent',mandatoryCode:'true',maxlengthName:'20',objTypeCode:'data',objTypeName:'data',skipOnBlurCodeValueEmpty:'N',skipOnBlurNameValueEmpty:'N'}}]}]}]}]},{T:1,N:'xf:group',A:{class:'btn-shbox',id:'',style:''},E:[{T:1,N:'xf:trigger',A:{class:'btn ico refresh',id:'btn_init',style:'',type:'button','ev:onclick':'scwin.f_InitObjects'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'새로고침'}]}]},{T:1,N:'xf:trigger',A:{class:'btn sch',disabled:'',escape:'false',id:'btn_Retrieve',style:'',type:'button',userAuth:'R','ev:onclick':'scwin.f_Retrieve'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'조회'}]}]}]}]},{T:1,N:'xf:group',A:{class:'title-wrap',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'title',id:''},E:[{T:1,N:'w2:textbox',A:{class:'tit',id:'',label:'채권내역(대변)',style:'',tagname:'h3'}}]},{T:1,N:'xf:group',A:{class:'right',id:''},E:[{T:1,N:'w2:udc_topGrdBtn',A:{grp:'grd_section1',style:'',gridDownYn:'N',gridUpYn:'N',gridID:'gr_acctRecv'}}]}]},{T:1,N:'xf:group',A:{adaptiveThreshold:'',class:'gvwbox',id:'grd_section1',style:''},E:[{T:1,N:'w2:gridView',A:{autoFit:'none',checkAllType:'false',class:'wq_gvw',dataList:'data:ds_acctRecv',id:'gr_acctRecv',style:'',visibleRowNum:'12',visibleRowNumFix:'true',readOnly:'true',resize:'true',columnMove:'true',rowStatusVisible:'true','ev:oncellclick':'scwin.gr_acctRecv_oncellclick'},E:[{T:1,N:'w2:caption',A:{id:'caption1',style:'',value:'this is a grid caption.'}},{T:1,N:'w2:header',A:{id:'header1',style:''},E:[{T:1,N:'w2:row',A:{id:'row1',style:''},E:[{T:1,N:'w2:column',A:{displayMode:'label',id:'num',inputType:'text',value:'선택',width:'70',sortable:'false'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'mgntNo',inputType:'text',value:'세금계산서번호',width:'130'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'acctRecvOutbrDt',inputType:'text',value:'청구일자',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'collMoneyAcctDeptNm',inputType:'text',value:'청구(수금)부서',width:'150'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'sellAcctDeptNm',inputType:'text',value:'매출부서',width:'150'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'acctNm',inputType:'text',value:'계정코드',width:'120'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'amt',inputType:'text',value:'청구금액(원)',width:'120'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'ramt',inputType:'text',value:'잔액(원)',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'amtFcrc',inputType:'text',value:'청구금액(외)',width:'120'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'ramtFcrc',inputType:'text',value:'잔액(외)',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'crcCd',inputType:'text',value:'통화',width:'70'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'exchRt',inputType:'text',value:'환율',width:'70'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'summary',inputType:'text',value:'적요',width:'150'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'acctCd',inputType:'text',value:'계정코드',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'collMoneyIntendDt',inputType:'text',value:'수금예정일자',width:'120'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'cdEngNm',inputType:'text',value:'통화코드Desc ',width:'130'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'checknum',inputType:'text',value:'CheckBox검사용',width:'150'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'acctRecvNo',inputType:'text',value:'채권번호',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'collMoneyAcctDeptCd',inputType:'text',value:'청구(수금)귀속부서코드',width:'200'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'bilgAcctDeptCd',inputType:'text',value:'청구귀속부서코드',width:'180'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'sellAcctDeptCd',inputType:'text',value:'매출귀속부서코드',width:'180'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'clntNo',inputType:'text',value:'거래처번호',width:'120'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'coCd',inputType:'text',value:'회사코드',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'coClsCd',inputType:'text',value:'회사구분코드',width:'130'}}]}]},{T:1,N:'w2:gBody',A:{id:'gBody1',style:''},E:[{T:1,N:'w2:row',A:{id:'row2',style:''},E:[{T:1,N:'w2:column',A:{displayMode:'label',id:'num',inputType:'checkbox',width:'70',trueValue:'T',falseValue:'F',valueType:'other',checkAlways:'true',readOnly:'false',fixColumnWidth:'true'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'mgntNo',inputType:'text',width:'130',textAlign:'right'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'acctRecvOutbrDt',inputType:'text',width:'100',textAlign:'center',displayFormat:'####/##/##'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'collMoneyAcctDeptNm',inputType:'text',width:'150',hidden:'true',hiddenCol:'true'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'sellAcctDeptNm',inputType:'text',width:'150'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'acctNm',inputType:'text',width:'120',textAlign:'center'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'amt',inputType:'text',width:'120',textAlign:'right',displayFormat:'#,##0'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'ramt',inputType:'text',width:'100',textAlign:'right',displayFormat:'#,##0'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'amtFcrc',inputType:'text',width:'120',textAlign:'right',displayFormat:'#,##0'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'ramtFcrc',inputType:'text',width:'100',textAlign:'right',displayFormat:'#,##0'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'crcCd',inputType:'text',width:'70',textAlign:'center'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'exchRt',inputType:'text',width:'70',textAlign:'right',displayFormat:'#,##0.00'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'summary',inputType:'text',width:'150',textAlign:'left'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'acctCd',inputType:'text',width:'100',hidden:'true',hiddenCol:'true'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'collMoneyIntendDt',inputType:'text',width:'120',hidden:'true',hiddenCol:'true'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'cdEngNm',inputType:'text',width:'130',hidden:'true',hiddenCol:'true'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'checknum',inputType:'text',width:'150',hidden:'true',hiddenCol:'true'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'acctRecvNo',inputType:'text',width:'100',hidden:'true',hiddenCol:'true'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'collMoneyAcctDeptCd',inputType:'text',width:'200',hidden:'true',hiddenCol:'true'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'bilgAcctDeptCd',inputType:'text',width:'180',hidden:'true',hiddenCol:'true'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'sellAcctDeptCd',inputType:'text',width:'180',hidden:'true',hiddenCol:'true'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'clntNo',inputType:'text',width:'120',hidden:'true',hiddenCol:'true'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'coCd',inputType:'text',width:'100',hidden:'true',hiddenCol:'true'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'coClsCd',inputType:'text',width:'130',hidden:'true',hiddenCol:'true'}}]}]},{T:1,N:'w2:footer',A:{id:'footer1',style:''},E:[{T:1,N:'w2:row',A:{id:'row3',style:''},E:[{T:1,N:'w2:column',A:{displayMode:'label',id:'column30',inputType:'text',width:'70'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column29',inputType:'text',width:'130'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column28',inputType:'text',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column27',inputType:'text',width:'150'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column26',inputType:'text',width:'150'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column25',inputType:'text',width:'120',value:'합계'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column24',inputType:'expression',expression:'sum(\'amt\')',textAlign:'right',displayFormat:'#,##0',width:'120'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column23',inputType:'expression',expression:'sum(\'ramt\')',textAlign:'right',displayFormat:'#,##0',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column21',inputType:'expression',expression:'sum(\'amtFcrc\')',textAlign:'right',displayFormat:'#,##0',width:'120'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column45',inputType:'expression',expression:'sum(\'ramtFcrc\')',textAlign:'right',displayFormat:'#,##0',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column33',inputType:'text',width:'70'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column36',inputType:'text',width:'70'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column39',inputType:'text',width:'150'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column63',inputType:'text',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column60',inputType:'text',width:'120'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column57',inputType:'text',width:'130'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column54',inputType:'text',width:'150'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column48',inputType:'text',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column51',inputType:'text',width:'200'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column72',inputType:'text',width:'180'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column69',inputType:'text',width:'180'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column66',inputType:'text',width:'120'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column75',inputType:'text',width:'100'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column78',inputType:'text',width:'130'}}]}]}]},{T:1,N:'xf:group',A:{class:'grid-bottom ',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'left',id:''},E:[{T:1,N:'xf:group',A:{class:'grid-total',id:''},E:[{T:1,N:'w2:textbox',A:{class:'',id:'',label:'총',style:'',tagname:'span'}},{T:1,N:'w2:textbox',A:{class:'num',id:'tbx_totalRows',label:'0',style:'',tagname:'span'}},{T:1,N:'w2:textbox',A:{class:'',id:'',label:'건',style:'',tagname:'span'}}]},{T:1,N:'xf:group',A:{class:'amt-wrap',id:'',tagname:'ul'},E:[{T:1,N:'xf:group',A:{id:'',tagname:'li'},E:[{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'선택금액(원)',style:'',tagname:'span'}},{T:1,N:'xf:input',A:{class:'tar',id:'ed_selectAmt',placeholder:'',style:'',objType:'key',mandatory:'true',title:'선택금액(원)',maxlength:'20',allowChar:'0-9',displayFormat:'#,##0',dataType:'number'}}]},{T:1,N:'xf:group',A:{id:'',tagname:'li'},E:[{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'선택금액(외)',style:'',tagname:'span'}},{T:1,N:'xf:input',A:{class:'tar',id:'ed_selectAmtFcrc',placeholder:'',style:'',objType:'key',mandatory:'true',title:'선택금액(외)',maxlength:'20',allowChar:'0-9',displayFormat:'#,##0',dataType:'number'}}]}]}]}]}]},{T:1,N:'xf:group',A:{class:'tbbox',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'w2tb',id:'',style:'',tagname:'table'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:summary'}]},{T:1,N:'xf:group',A:{tagname:'colgroup'},E:[{T:1,N:'xf:group',A:{style:'width:120px;',tagname:'col'}},{T:1,N:'xf:group',A:{tagname:'col'}},{T:1,N:'xf:group',A:{style:'width: 120px;',tagname:'col'}},{T:1,N:'xf:group',A:{tagname:'col'}},{T:1,N:'xf:group',A:{style:'',tagname:'col'}}]},{T:1,N:'xf:group',A:{style:'',tagname:'tr'},E:[{T:1,N:'xf:group',A:{class:'w2tb_th',style:'',tagname:'th'},E:[{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'작업일자',ref:'',style:'',userData2:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',style:'',tagname:'td'},E:[{T:1,N:'w2:inputCalendar',A:{calendarValueType:'yearMonthDate',class:' cal',id:'ed_wrkDt',title:'작업일자',style:'',objType:'data',mandatory:'true',displayFormat:'yyyy/MM/dd'}}]},{T:1,N:'xf:group',A:{class:'w2tb_th',tagname:'th'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'계정코드',ref:'',style:'',userData2:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',tagname:'td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:autoComplete',A:{class:'form-control w150',editType:'select',id:'acb_acctCd',search:'start',style:'',submenuSize:'auto',allOption:'',disabled:'false',displayMode:'value delim label',searchTarget:'both'}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',tagname:'td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'xf:trigger',A:{class:'btn',id:'btn_Save',style:'',type:'button',objType:'bSave',userAuth:'C','ev:onclick':'scwin.f_Save'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'처리'}]}]}]}]}]}]}]}]}]}]})