...
scwin.f_resultPopEd = function (strCd, strNm, rtnList, flag) {
  console.log("=== f_resultPopEd (팝업결과)   flag [" + flag + "]  rtnList [" + rtnList + "]  1:구청코드)");
...
scwin.f_OzReport = async function () {
  ...
  // var odiParam = new ODIParam("fi_404_01_05p") ;
  ...
  // cfOZEmbedPreview("ozFrame", "myozviewer", "/ac/fi/taxbiz/withhold/fi_404_01_05p.ozr", odiParam, viewerParam, formParam);

  let data = {
    odiName: "fi_404_01_05p",
    reportName: "/ac/fi/taxbiz/withhold/fi_404_01_05p.ozr",
    odiParam: {
