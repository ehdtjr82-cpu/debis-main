...
//           레포트 화면
//           
// 레포트   : fi_401_01_04p.ozr  (매입)
//           fi_401_01_04p_1.ozr  (매출)
// 업로드   :
// 다운로드 : 
// 호출     :
//            
...
scwin.ica_declarYr_onblur = function (e) {
  ...
  // language=JavaScript for=ed_declarYr event=OnKillFocus()>
...
scwin.f_openPopUp = function (flag, check) {
  ...
  console.log("  부가세신고부서popup  param [" + param + "]");
...
scwin.udc_coCd_callBackFunc = function (rtnList) {
  ...
  if (rtnList != null) {
    ...
    console.log("  --- --- ed_coCd_hidVal [" + scwin.ed_coCd_hidVal + "]  rtnList[0] [" + rtnList[0] + "]");
...
scwin.f_OzReport = async function (e) {
  ...
  if (ica_declarYr.getValue().length < 4) {
    // %1은(는) %2자리수만큼 입력하십시오."
    $c.gus.cfAlertMsg($p, $c.data.getMessage($p, MSG_CM_ERR_005, "기간", "4"));
    ica_declarYr.focus();
    return false;
  }
  scwin.f_DateSetting();
  ...
  if (lc_pchsSellClsCd.getValue() == "1") {
    console.log(" ----- 매입");
    // 	var odiParam = new ODIParam("fi_401_01_04p") ;
    ...
    // 	odiParam.add("pchsSellClsCd",lc_pchsSellClsCd.BindColVal.trim());
    ...
    // cfOZEmbedPreview("ozFrame", "myozviewer", "/ac/fi/taxbiz/vatctrl/fi_401_01_04p.ozr", odiParam, viewerParam, formParam);

    let data = {
      reportName: "/ac/fi/taxbiz/vatctrl/fi_401_01_04p.ozr",
      odiName: "fi_401_01_04p",
      odiParam: {
        ...
        pchsSellClsCd: lc_pchsSellClsCd.getValue(),
    ...
    console.log("  세금계산서합계표(매입) data [" + JSON.stringify(data) + "]");
    wfm_ozReport.getWindow().mf_scwin.reportSearch(data);
  } else {
    console.log(" ----- 매출");
    // 매출일경우

    // 	var odiParam = new ODIParam("fi_401_01_04p_1") ;
    // odiParam.add("sysPath", "dbl.ac.fi.taxbiz.vatctrl") ;
    ...
    //                iframe     viewer        OZR 경로 및 파일명  ODI파라미터 뷰어파라미터       폼파라미터
    // cfOZEmbedPreview("ozFrame", "myozviewer", "/ac/fi/taxbiz/vatctrl/fi_401_01_04p_1.ozr", odiParam, viewerParam, formParam);

    let data = {
      reportName: "/ac/fi/taxbiz/vatctrl/fi_401_01_04p_1.ozr",
      odiName: "fi_401_01_04p_1",
      odiParam: {
        sysPath: "dbl.ac.fi.taxbiz.vatctrl",
        declarYr: ica_declarYr.getValue().trim(),
        vatQuartYyClsCd: ds_search.get("vatQuartYyClsCd"),
    ...
    console.log("  세금계산서합계표(매출) data [" + JSON.stringify(data) + "]");
    wfm_ozReport.getWindow().mf_scwin.reportSearch(data);
  }
};
}}}]},{T:1,N:'w2:require',A:{as:'udc_topGrdBtn',type:'page',variableClone:'true',src:'/cm/udc/topGrdBtn.xml'}},{T:1,N:'w2:require',A:{as:'udc_bottomGrdBtn',type:'page',variableClone:'true',src:'/cm/udc/bottomGrdBtn.xml'}},{T:1,N:'w2:require',A:{as:'udc_comCode',type:'page',variableClone:'',src:'/cm/udc/comCode.xml'}}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload'},E:[{T:1,N:'xf:group',A:{class:'sub_contents',id:'',style:''},E:[{T:1,N:'w2:wframe',A:{id:'',src:'/cm/xml/contentHeader.xml',style:''}},{T:1,N:'xf:group',A:{class:'shbox',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'shbox-inner',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'w2tb',id:'',style:'',tagname:'table'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:summary'}]},{T:1,N:'xf:group',A:{tagname:'colgroup'},E:[{T:1,N:'xf:group',A:{style:'',tagname:'col'}},{T:1,N:'xf:group',A:{style:'',tagname:'col'}},{T:1,N:'xf:group',A:{style:'',tagname:'col'}},{T:1,N:'xf:group',A:{tagname:'col'}},{T:1,N:'xf:group',A:{tagname:'col'}},{T:1,N:'xf:group',A:{tagname:'col'}},{T:1,N:'xf:group',A:{tagname:'col'}},{T:1,N:'xf:group',A:{style:'',tagname:'col'}}]},{T:1,N:'xf:group',A:{id:'',tagname:'tr'},E:[{T:1,N:'xf:group',A:{class:'w2tb_th',tagname:'th'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:scope',E:[{T:3,text:'row'}]}]},{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'회사코드 ',style:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',tagname:'td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:udc_comCode',A:{popupID:'retrieveDongbuGroupCompanyInfopopup',selectID:'retrieveDongbuGroupCompanyInfo',codeId:'ed_coCd',popupTitle:'',nameId:'ed_coNm',style:'',id:'udc_coCd',btnId:'btn_coCd',allowCharCode:'0-9',mandatoryCode:'true',objTypeCode:'data',maxlengthCode:'3',maxlengthName:'50',objTypeName:'data','ev:onblurCodeEvent':'scwin.udc_coCd_onblurCodeEvent','ev:onclickEvent':'scwin.udc_coCd_onclickEvent',refDataCollection:'ds_search',code:'coCd',name:'coNm',validTitle:'회사코드',skipOnBlurCodeValueEmpty:'N'}}]},{T:1,N:'xf:group',A:{class:'w2tb_th',tagname:'th'},E:[{T:1,N:'w2:attributes',E:[{T:1,N:'w2:scope',E:[{T:3,text:'row'}]}]},{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'매입/출 ',style:''}}]},{T:1,N:'xf:group',A:{class:'w2tb_td',id:'',tagname:'td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'xf:select1',A:{allOption:'',appearance:'minimal',chooseOption:'',class:'',direction:'auto',disabled:'false',disabledClass:'w2selectbox_disabled',id:'lc_pchsSellClsCd',style:'width: 100px;',submenuSize:'auto',ref:'data:ds_search.pchsSellClsCd',title:'매입매출구분',mandatory:'true'},E:[{T:1,N:'xf:choices',E:[{T:1,N:'xf:item',E:[{T:1,N:'xf:label',E:[{T:4,cdata:'매입'}]},{T:1,N:'xf:value',E:[{T:4,cdata:'1'}]}]},{T:1,N:'xf:item',E:[{T:1,N:'xf:label',E:[{T:4,cdata:'매출'}]},{T:1,N:'xf:value',E:[{T:4,cdata:'2'}]}]}]}]}]},{T:1,N:'xf:group',A:{tagname:'th',id:'',class:'w2tb_th'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:textbox',A:{class:'',id:'',label:'부가세신고부서 ',style:''}}]},{T:1,N:'xf:group',A:{tagname:'td',id:'',class:'w2tb_td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'xf:group',A:{class:'form-group',id:'',style:''},E:[{T:1,N:'w2:udc_comCode',A:{btnId:'btn_vatDeclarAcctDeptCd',code:'vatDeclarAcctDeptCd',codeId:'ed_vatDeclarAcctDeptCd','ev:onblurCodeEvent':'scwin.udc_vatDeclarAcctDeptCd_onblurCodeEvent','ev:onclickEvent':'scwin.udc_vatDeclarAcctDeptCd_onclickEvent',id:'udc_vatDeclarAcctDeptCd',name:'vatDeclarAcctDeptNm',nameId:'ed_vatDeclarAcctDeptNm',popupID:'retrieveVatDeclarAcctDeptCdpopup',popupTitle:'',refDataCollection:'ds_search',selectID:'retrieveVatDeclarAcctDeptCd',style:'',allowCharCode:'0-9',maxlengthCode:'5',skipOnBlurCodeValueEmpty:'N',maxlengthName:'50',validTitle:'부가세신고부서',skipOnBlurNameValueEmpty:'N'}},{T:1,N:'xf:input',A:{class:' w150',id:'ed_vatDeclarCrn',ref:'data:ds_search.crn',style:'',title:'부가세사업자번호'}}]}]},{T:1,N:'xf:group',A:{tagname:'th',id:'',class:'w2tb_th'},E:[{T:1,N:'w2:attributes'},{T:1,N:'w2:textbox',A:{class:'req',id:'',label:'기간 ',style:''}}]},{T:1,N:'xf:group',A:{tagname:'td',id:'',class:'w2tb_td'},E:[{T:1,N:'w2:attributes'},{T:1,N:'xf:group',A:{class:'form-group',id:'',style:''},E:[{T:1,N:'xf:input',A:{class:' w100','ev:onblur':'scwin.ica_declarYr_onblur',id:'ica_declarYr',placeholder:'',ref:'data:ds_search.declarYr',style:'',title:'기간',mandatory:'true',allowChar:'0-9',maxlength:'4'}},{T:1,N:'xf:select1',A:{allOption:'false',appearance:'minimal',chooseOption:'false',class:' w150',direction:'auto',disabled:'false',disabledClass:'w2selectbox_disabled',id:'lc_vatQuartYyClsCd',ref:'data:ds_search.vatQuartYyClsCd',style:'',submenuSize:'auto',title:'부가세분기구분코드',mandatory:'true'}}]}]}]}]}]},{T:1,N:'xf:group',A:{class:'btn-shbox',id:'',style:''},E:[{T:1,N:'xf:trigger',A:{class:'btn sch',disabled:'',escape:'false',id:'btn_retrieve',style:'',type:'button','ev:onclick':'scwin.f_OzReport',userAuth:'P'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'조회'}]}]}]}]},{T:1,N:'xf:group',A:{class:'round-box',id:'',style:''},E:[{T:1,N:'xf:group',A:{id:'ozFrame',class:'ozWrap'},E:[{T:1,N:'w2:iframe',A:{src:'/ui/cm/zz/ozreportComp.xml',style:'',id:'wfm_ozReport'}}]}]}]}]}]}]})