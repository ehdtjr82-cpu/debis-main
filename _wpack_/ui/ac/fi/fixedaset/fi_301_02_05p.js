/*amd /ui/ac/fi/fixedaset/fi_301_02_05p.xml 21853 d5b17bb8d6bfb27be4a12548234b01e9d51e865378b0caaffd4632bd3875959e */
define({declaration:{A:{version:'1.0',encoding:'UTF-8'}},E:[{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',A:{},E:[{T:1,N:'w2:type',E:[{T:3,text:'COMPONENT'}]},{T:1,N:'w2:buildDate'},{T:1,N:'w2:MSA'},{T:1,N:'xf:model',E:[{T:1,N:'w2:dataCollection',A:{baseNode:'map'},E:[{T:1,N:'w2:dataMap',A:{baseNode:'map',id:'dma_search'},E:[{T:1,N:'w2:keyInfo',E:[{T:1,N:'w2:key',A:{id:'fixedAsetNo',name:'고정자산번호',dataType:'text'}},{T:1,N:'w2:key',A:{id:'fromClsCd',name:'출처구분',dataType:'text'}},{T:1,N:'w2:key',A:{id:'fixedAsetHistClsCd',name:'고정자산이력구분코드',dataType:'text'}},{T:1,N:'w2:key',A:{id:'slipNo',name:'전표번호',dataType:'text'}},{T:1,N:'w2:key',A:{id:'slipKndCd',name:'전표종류',dataType:'text'}},{T:1,N:'w2:key',A:{id:'apprvReqNo',name:'결재요청번호',dataType:'text'}},{T:1,N:'w2:key',A:{id:'evidClsCd',name:'증빙파일종류',dataType:'text'}}]}]},{T:1,N:'w2:dataList',A:{baseNode:'list',repeatNode:'map',id:'ds_fileList',saveRemovedData:'false'},E:[{T:1,N:'w2:columnInfo',E:[{T:1,N:'w2:column',A:{id:'prmrNo',name:'구분번호',dataType:'text'}},{T:1,N:'w2:column',A:{id:'fromClsCd',name:'출처구분코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'fileName',name:'파일명',dataType:'text'}},{T:1,N:'w2:column',A:{id:'filePath',name:'파일경로',dataType:'text'}},{T:1,N:'w2:column',A:{id:'fileSize',name:'FILE크기',dataType:'text'}},{T:1,N:'w2:column',A:{id:'fixedAsetNo',name:'고정자산번호',dataType:'text'}},{T:1,N:'w2:column',A:{id:'fixedAsetHistClsCd',name:'고정자산이력구분코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'slipNo',name:'DEBIS전표번호',dataType:'text'}},{T:1,N:'w2:column',A:{id:'slipKndCd',name:'전표종류코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'slipKndNm',name:'전표종류명',dataType:'text'}},{T:1,N:'w2:column',A:{id:'rmkregId',name:'',dataType:'text'}},{T:1,N:'w2:column',A:{id:'regDtmmodId',name:'',dataType:'text'}},{T:1,N:'w2:column',A:{id:'modDtm',name:'수정일시',dataType:'text'}},{T:1,N:'w2:column',A:{id:'fixedAsetPrmrNo',name:'자산증빙구분번호',dataType:'text'}},{T:1,N:'w2:column',A:{id:'evidClsCd',name:'증빙구분코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'evidClsNm',name:'증빙구분명',dataType:'text'}},{T:1,N:'w2:column',A:{id:'receptYn',name:'영수여부(1:예,0:아니오)',dataType:'text'}},{T:1,N:'w2:column',A:{id:'chk',name:'선택',dataType:'text',ignoreStatus:'true',defaultValue:'0'}},{T:1,N:'w2:column',A:{id:'FILE_STORED_PATH',name:'파일저장경로',dataType:'text'}},{T:1,N:'w2:column',A:{id:'STORED_FILE_NM',name:'저장파일명',dataType:'text'}},{T:1,N:'w2:column',A:{id:'ORIGIN_FILE_NM',name:'원본파일명',dataType:'text'}},{T:1,N:'w2:column',A:{id:'FILE_EXPLAIN',name:'파일설명',dataType:'text'}},{T:1,N:'w2:column',A:{id:'FILE_SIZE',name:'파일크기',dataType:'text'}},{T:1,N:'w2:column',A:{id:'status',name:'파일전송상태',dataType:'text'}}]}]},{T:1,N:'w2:dataList',A:{baseNode:'list',repeatNode:'map',id:'ds_fileUploadGDS',saveRemovedData:'false'},E:[{T:1,N:'w2:columnInfo',E:[{T:1,N:'w2:column',A:{id:'prmrNo',name:'구분번호',dataType:'text'}},{T:1,N:'w2:column',A:{id:'fileName',name:'파일명',dataType:'text'}},{T:1,N:'w2:column',A:{id:'filePath',name:'파일경로',dataType:'text'}},{T:1,N:'w2:column',A:{id:'fileSize',name:'FILE크기',dataType:'text'}},{T:1,N:'w2:column',A:{id:'fixedAsetNo',name:'고정자산번호',dataType:'text'}},{T:1,N:'w2:column',A:{id:'fixedAsetHistClsCd',name:'고정자산이력구분코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'slipNo',name:'DEBIS전표번호',dataType:'text'}},{T:1,N:'w2:column',A:{id:'slipKndCd',name:'전표종류코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'apprvReqNo',name:'결재요청번호',dataType:'text'}},{T:1,N:'w2:column',A:{id:'fixedAsetPrmrNo',name:'자산증빙구분번호',dataType:'text'}},{T:1,N:'w2:column',A:{id:'evidClsCd',name:'증빙구분코드',dataType:'text'}},{T:1,N:'w2:column',A:{id:'regId',name:'등록자ID',dataType:'text'}},{T:1,N:'w2:column',A:{id:'chk',name:'선택',dataType:'text',ignoreStatus:'true',defaultValue:'0'}},{T:1,N:'w2:column',A:{id:'FILE_STORED_PATH',name:'파일저장경로',dataType:'text'}},{T:1,N:'w2:column',A:{id:'STORED_FILE_NM',name:'저장파일명',dataType:'text'}},{T:1,N:'w2:column',A:{id:'ORIGIN_FILE_NM',name:'원본파일명',dataType:'text'}},{T:1,N:'w2:column',A:{id:'FILE_EXPLAIN',name:'파일설명',dataType:'text'}},{T:1,N:'w2:column',A:{id:'FILE_SIZE',name:'파일크기',dataType:'text'}},{T:1,N:'w2:column',A:{id:'status',name:'파일전송상태',dataType:'text'}}]}]}]},{T:1,N:'xf:submission',A:{id:'sbm_retrieve',action:'/ac.fi.fixedaset.RetreiveeAssetsEvidenceInfoAttachFileListCMD.do',method:'post',mediatype:'application/json',ref:'data:json,[{"id":"dma_search","key":"IN_DS1"},{"id":"ds_fileList","key":"OUT_DS1"}]',encoding:'UTF-8',instance:'',replace:'',errorHandler:'',customHandler:'',target:'data:json,{"id":"ds_fileList","key":"OUT_DS1"}',mode:'asynchronous',processMsg:'','ev:submit':'','ev:submitdone':'scwin.sbm_retrieve_submitdone','ev:submiterror':'',abortTrigger:''}},{T:1,N:'xf:submission',A:{id:'sbm_save',action:'/ac.fi.fixedaset.SaveAssetsEvidenceInfoAttachFileCMD.do',method:'post',mediatype:'application/json',ref:'data:json,[{"action":"modified","id":"ds_fileUploadGDS","key":"IN_DS1"},{"action":"all","id":"dma_search","key":"IN_DS2"}]',sinstance:'',replace:'',errorHandler:'',customHandler:'',mode:'asynchronous',processMsg:'','ev:submit':'','ev:submitdone':'scwin.sbm_save_submitdone','ev:submiterror':'',abortTrigger:''}},{T:1,N:'w2:workflowCollection'}]},{T:1,N:'w2:layoutInfo'},{T:1,N:'w2:publicInfo',A:{method:''}},{T:1,N:'script',A:{lazy:'false',type:'text/javascript'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){/**
 * 화 면 명 : 고정자산조회및변경_파일업로드
 * 메뉴경로 : 회계/재무회계/고정자산/고정자산조회및변경(fi_301_02_01b.xml)
 * ASIS경로 : /debis/dongwon-debis-engine/src/main/webapp/ac/fi/fixedaset/fi_301_02_05p.jsp
 * 작 성 자 : 배기원
 * 작 업 일 : 2025-11-25
 * 작업내용 :
 *    1. 화면세팅
...
//scwin.systemPathVal =  DSystemCode.FI+"/fixedaset/evidAttachFile/"+fixedAsetNo+"/"+fixedAsetHistClsCd+"/"+slipNo;
...
scwin.sbm_retrieve_submitdone = function (e) {
  ...
  for (let i = 0; i < rowCnt; i++) {
    ...
    // let slipKndNm = ds_fileList.getCellData(i, "slipKndNm");
    // let evidClsNm = ds_fileList.getCellData(i, "evidClsNm");
    // if($c.util.isEmpty(slipNo)) {
    //     fileNm = "[전표번호]0000000000" + " [전표종류]고정자산 ["+ evidClsNm +"]";
    // }else {
    //     fileNm = "[전표번호]"+slipNo+" [전표종류]"+slipKndNm + " ["+ evidClsNm +"]";
    // }
    // ds_fileList.setCellData(i, "ORIGIN_FILE_NM"  , fileNm);
    //ds_fileList.setCellData(i, "ORIGIN_FILE_NM"  , ds_fileList.getCellData(i, "filePath"));

    let slipNo = ds_fileList.getCellData(i, "slipNo");
    if ($c.util.isEmpty($p, slipNo)) {
      ds_fileList.setCellData(i, "slipNo", "0000000000");
      ds_fileList.setCellData(i, "slipKndNm", "고정자산");
    }
    let fileSize = ds_fileList.getCellData(i, "fileSize");
    if (!$c.util.isEmpty($p, fileSize)) {
      // ds_fileList.setCellData(i, "fileSize", "("+fileSize +"bytes)");            
      ds_fileList.setCellData(i, "fileSize", $c.num.formatByte($p, fileSize));
    }
  }
  ds_fileList.reform();
  totalRows.setValue(rowCnt);
  scwin.subDir = scwin.systemPathVal + scwin.fixedAsetNo + "/" + scwin.fixedAsetHistClsCd + "/" + scwin.slipNo;
  scwin.subDir = scwin.subDir.replace("//", "/");
...
scwin.dataSetDebug = function (dataSet, isDebug) {
  if (isDebug == true) {
    ...
    for (var dsRow = 0; dsRow <= obj.getRowCount(); dsRow++) {
      for (var dsCol = 0; dsCol <= obj.getTotalCol(); dsCol++) {
        str += "[" + obj.getColumnID(dsCol) + "] " + obj.getCellData(dsRow, obj.getColumnID(dsCol)) + ", ";
      }
      str += "\n\n";
    }
    $c.win.alert($p, str);
...
scwin.f_saveFile = function () {
  // tr_create.Parameters = "fixedAsetNo=<%=fixedAsetNo%>,fixedAsetHistClsCd=00";
  // tr_create.post();
  dma_search.set("fixedAsetNo", scwin.fixedAsetNo);
  dma_search.set("fixedAsetHistClsCd", "00");
...
scwin.fileSubmit = async function () {
  ...
  if (!(await $c.win.confirm($p, "자산번호:" + scwin.fixedAsetNo + "에<BR>파일을 업로드 하시겠습니까?"))) {
    return;
  }
...
}}}]},{T:1,N:'w2:require',A:{as:'udc_fileMultiUpload',type:'page',variableClone:'',src:'/cm/udc/fileMultiUpload.xml'}}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload'},E:[{T:1,N:'xf:group',A:{class:'round-box',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'lybox wfix flex_no',id:''},E:[{T:1,N:'xf:group',A:{class:'col',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'file-wrap',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'title-wrap',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'title',id:''},E:[{T:1,N:'w2:textbox',A:{class:'tit',id:'',label:'첨부예정 List',style:'',tagname:'h3'}}]}]},{T:1,N:'w2:udc_fileMultiUpload',A:{'ev:onFileUploadDone':'scwin.uploadComplete',fileGrpSeq:'',filter:'gif, jpg, bmp, png, zip, txt, ppt, pptx, xls, xlsx, doc, docx, xml, csv, pdf',id:'udc_fielUpload',maxFileCount:'10',maxFileSize:'536870912',saveFn:'scwin.fileSubmit',style:'',totalFileSize:'2009715200',fileTypeYn:'Y'}}]}]},{T:1,N:'xf:group',A:{class:'col',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'title-wrap',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'title',id:''},E:[{T:1,N:'w2:textbox',A:{class:'tit',id:'',label:'첨부완료 List',style:'',tagname:'h3'}}]},{T:1,N:'xf:group',A:{class:'right',id:''}}]},{T:1,N:'xf:group',A:{adaptiveThreshold:'',class:'gvwbox',id:'group2',style:''},E:[{T:1,N:'w2:gridView',A:{autoFit:'allColumn',checkAllType:'false',class:'wq_gvw',dataList:'data:ds_fileList',enterKeyMove:'editRight',focusMode:'cell',id:'grdFileList',keepDefaultColumnWidth:'true',rowStatusWidth:'20',style:'',visibleRowNum:'5',visibleRowNumFix:'true',readOnly:'true','ev:oncellclick':'scwin.grdFileList_oncellclick'},E:[{T:1,N:'w2:caption',A:{id:'caption2',style:'',value:'this is a grid caption.'}},{T:1,N:'w2:header',A:{id:'header1',style:''},E:[{T:1,N:'w2:row',A:{id:'row1',style:''},E:[{T:1,N:'w2:column',A:{displayMode:'label',id:'column1',inputType:'text',value:'전표번호',width:'140'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'column17',inputType:'text',value:'전표종류',width:'140'}},{T:1,N:'w2:column',A:{width:'140',inputType:'text',style:'',id:'column18',value:'증빙파일종류',displayMode:'label'}},{T:1,N:'w2:column',A:{class:'txt-blue',displayMode:'label',id:'column13',inputType:'text',value:'파일명',width:'250'}},{T:1,N:'w2:column',A:{class:'',displayMode:'label',id:'column11',inputType:'text',value:'파일크기',width:'120'}}]}]},{T:1,N:'w2:gBody',A:{id:'gBody1',style:''},E:[{T:1,N:'w2:row',A:{id:'row2',style:''},E:[{T:1,N:'w2:column',A:{displayMode:'label',id:'slipNo',inputType:'text',readOnly:'true',width:'140'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'slipKndNm',inputType:'text',readOnly:'true',textAlign:'left',width:'140'}},{T:1,N:'w2:column',A:{width:'140',inputType:'text',style:'',id:'evidClsNm',value:'',displayMode:'label'}},{T:1,N:'w2:column',A:{displayMode:'label',id:'fileName',inputType:'link',mandatory:'true',readOnly:'true',textAlign:'left',width:'250',value:'',class:'linktype'}},{T:1,N:'w2:column',A:{class:'',displayMode:'label',id:'fileSize',inputType:'text',width:'120'}}]}]}]},{T:1,N:'xf:group',A:{class:'grid-bottom ',id:'',style:''},E:[{T:1,N:'xf:group',A:{class:'left',id:''},E:[{T:1,N:'xf:group',A:{class:'grid-total',id:''},E:[{T:1,N:'w2:textbox',A:{class:'',id:'',label:'총',style:'',tagname:'span'}},{T:1,N:'w2:textbox',A:{class:'num',dataType:'number',displayFormat:'#,##0',id:'totalRows',label:'0',style:'',tagname:'span'}},{T:1,N:'w2:textbox',A:{class:'',id:'',label:'건',style:'',tagname:'span'}}]}]},{T:1,N:'xf:group',A:{class:'right',id:'',style:''}}]}]}]}]}]}]}]}]})