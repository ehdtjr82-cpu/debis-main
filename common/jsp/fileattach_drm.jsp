...
<tr>
	<td>
		<div style='width:100%;height:0;overflow:hidden;position:relative;right:-80px;filter:alpha(opacity=0);-moz-opacity:0'>
	...
	<td>
		...
		<img src="/common/images/icon_excel_up.gif" align="absmiddle"	style="cursor:hand" id="btnDrmExcelUp">
	</td>
</tr>
</table>
<!-- <fieldset> -->
<%-- 	<div style="width:100%;height:0;overflow:auto" id='<%=DISPLAY_ITEMS%>' style="display:none;"></div> --%>
<!-- </fieldset> -->
