<%--
	화면 - $Id: outsystem_setoffdelete.jsp,v 1.4 2008/04/01 06:02:10 신종민 Exp $
	설명 - 외부시스템 상계 전표를 삭제
--%>
...
<%@ page import="dbl.ac.fi.gnrlaccount.osidesysproc.bd.DeleteOutsideSystemSetoffBD" %>
...
<%
	...
	try {
		DeleteOutsideSystemSetoffBD deleteOutsideSystemSetoffBD = new DeleteOutsideSystemSetoffBD();
		new DCommonBDExecutor(deleteOutsideSystemSetoffBD).executeTx(outsideSystemContentsDTO);
