...
<%!	
	...
	void setOtherToday(Calendar c, String y, String m, String day){
		...
		*/
		...
		getMonthDay(Integer.parseInt(y), Integer.parseInt(m));
...
function setMonth(month) {
	...
	document.frmCalendar.action = "calendarMain.jsp";
...
<table width="270" height="265" border="0" cellpadding="0" cellspacing="0">
	<tr>
	...
	<table width="230" height="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<table width="244" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
			<td><img src="/common/images/Content_schedule_popupbar02.gif" width="241" height="15"></td>
			</tr>
			<tr>
