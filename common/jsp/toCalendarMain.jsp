...
<table width="220" height="235" border="0" cellpadding="0" cellspacing="0">
	<tr>
	...
	<table width="220" height="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<table width="210" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
			<td height="7" align="center"><img src="/common/images/Content_schedule_popupbar02.gif" width="210" height="5"></td>
			</tr>
			<tr>
			<td height="5" align="center">
			<table height="15" border="0" cellpadding="0" cellspacing="1" class="table_bg">
				<tr align="center" bgcolor="#F8F7EE">
				<td width="14" class="schedule_number_black" onmouseover=this.style.backgroundColor="#F3F0D2" onmouseout=this.style.backgroundColor="F8F7EE"><a href="javascript:setMonth('1')">1</a></td>
				<td width="14" class="schedule_number_black" onmouseover=this.style.backgroundColor="#F3F0D2" onmouseout=this.style.backgroundColor="F8F7EE"><a href="javascript:setMonth('2')">2</a></td>
				<td width="14" class="schedule_number_black" onmouseover=this.style.backgroundColor="#F3F0D2" onmouseout=this.style.backgroundColor="F8F7EE"><a href="javascript:setMonth('3')">3</a></td>
				<td width="14" class="schedule_number_black" onmouseover=this.style.backgroundColor="#F3F0D2" onmouseout=this.style.backgroundColor="F8F7EE"><a href="javascript:setMonth('4')">4</a></td>
				<td width="14" class="schedule_number_black" onmouseover=this.style.backgroundColor="#F3F0D2" onmouseout=this.style.backgroundColor="F8F7EE"><a href="javascript:setMonth('5')">5</a></td>
				<td width="14" class="schedule_number_black" onmouseover=this.style.backgroundColor="#F3F0D2" onmouseout=this.style.backgroundColor="F8F7EE"><a href="javascript:setMonth('6')">6</a></td>
				<td width="14" class="schedule_number_black" onmouseover=this.style.backgroundColor="#F3F0D2" onmouseout=this.style.backgroundColor="F8F7EE"><a href="javascript:setMonth('7')">7</a></td>
				<td width="14" class="schedule_number_black" onmouseover=this.style.backgroundColor="#F3F0D2" onmouseout=this.style.backgroundColor="F8F7EE"><a href="javascript:setMonth('8')">8</a></td>
				<td width="14" class="schedule_number_black" onmouseover=this.style.backgroundColor="#F3F0D2" onmouseout=this.style.backgroundColor="F8F7EE"><a href="javascript:setMonth('9')">9</a></td>
				<td width="14" class="schedule_number_black" onmouseover=this.style.backgroundColor="#F3F0D2" onmouseout=this.style.backgroundColor="F8F7EE"><a href="javascript:setMonth('10')">10</a></td>
				<td width="14" class="schedule_number_black" onmouseover=this.style.backgroundColor="#F3F0D2" onmouseout=this.style.backgroundColor="F8F7EE"><a href="javascript:setMonth('11')">11</a></td>
				<td width="14" class="schedule_number_black" onmouseover=this.style.backgroundColor="#F3F0D2" onmouseout=this.style.backgroundColor="F8F7EE"><a href="javascript:setMonth('12')">12</a></td>
				</tr>
			</table>
			</td>
			</tr>
			<tr>
			<td><img src="/common/images/Content_schedule_popupbar02.gif" width="220" height="5"></td>
			</tr>
			<tr>
			<td align="center"><strong><font size="2"><%=intMonth%>월</font></strong></td>
			</tr>
			<tr>
			<td><img src="/common/images/Content_schedule_popupbar02.gif" width="220" height="5"></td>
			</tr>
		...
		<table width="200" border="0" cellspacing="0" cellpadding="0">
			...
			<%  
				...
				while(index <= monthLength){
					out.print("<tr height=\"10\" align=\"center\">");
					out.println("\n");
					for(int j=0; j<=6; j++){
