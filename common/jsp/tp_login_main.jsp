...
<%!
/** 
* @source  : $Source: /CVS/cvs/cvsrepo/DBL_PROJECT/DBL_EAR/WEB_ROOT/common/jsp/tp_login_main.jsp,v $
* @date    : $Date: 2013/12/11 01:40:59 $
* @version : $Revision: 1.5 $
* @author  : $Author: kimseok $ 
*/
%> 
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html>
<head>
<title>한국용기순환협회</title>
  ...
  <tr>
    ...
    <td align="center"><table width="707" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td><table>
               <tr>
                   <td height="33" width = "560" valign="top"><a href="#"><img src="/common/images/kovra_ci.gif" width="147" height="24" border="0"></a></td>
          ...
          <td><table width="707" height="313" border="0" cellpadding="0" cellspacing="0" background="/common/images/main_bg.gif">
              <tr> 
                <td width="433" style="padding-left:11px ; padding-right:11px"><table width="433" height="291" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td align="center" background="/common/images/img_bg.gif"><img src="/common/images/img2.gif" width="425" height="283"></td>
                    </tr>
                  </table></td>
                <td><table width="240" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td height="148" valign="top"><img src="/common/images/left_img2.jpg" width="240" height="139"></td>
                    </tr>
                    <tr> 
