...
<%@ page import="dbl.ac.fi.gnrlaccount.osidesysproc.bd.UpdateOutsideCustomerBD" %>
...
//	DLog.debug("<<<HTTPRequest Parameters>>> 외부시스템코드 : " + osidePkgCd + ", 거래번호 : " + txnNo);
	...
	try {
		...
		UpdateOutsideCustomerBD updateOutsideCustomerBD = new UpdateOutsideCustomerBD();
		new DCommonBDExecutor(updateOutsideCustomerBD).executeTx(resultsDTO);
	} catch (Exception e) {
