  ...
  function jsChangeBoard( obj, selectBoardId ) { 
    ...
    switch (vUserClsCd) {
        ...
        case '70': 
         ...
         boardURL = "/cm/bc/salesmgnt/zz_820_01_04b.jsp" ;
         boardTitle = "Main" ;  
      ...
      <table width="100%" height="65" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="40" valign="bottom">
            <table border="0" width="100%" height="41" border="0" cellpadding="0" cellspacing="0">
              <tr>
                  ...
                  <table width="800" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td align= "right">
                      ...
                      <!--  <td><img src="/common/images/cs_img.gif"></td>
                        <font color="#4641D9" size="5" ><b>동부익스프레스 영업정보지원시스템</b></font>-->
                      </td>
                      <% } %>
                      <td>
                      </td>                      
