<%--
 화면 - $Id: zz_620_01_04b_01.jsp,v 1.1 2013/04/24 12:12:03 kimseok Exp $
 설명 - 개인정보변경
--%>
...
<script language="javascript" src="/common/script/security.js"></script>
...
var MSG_LO_ERR_006 = "입력하신 비밀번호가 다릅니다. 정확히 입력하세요.";
  ...
  function f_Next()	{
	  ...
	  var  passwd = Decrypt("<%=passwd%>", "passwd", 128);
	  oGDS_login.NameValue(1,"passwd") = passwd;
