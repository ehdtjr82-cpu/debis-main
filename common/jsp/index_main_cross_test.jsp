...
<frameset id="OUT_FRAMESET" rows="0,*" frameborder="no" border="1" framespacing="0" noresize cols="*"> 
  ...
  <frame name="workFrame" scrolling="no" src="/common/jsp/active_update_cross_test.jsp?EP_FORWARD=FALSE&porteYn=<%=porteYn%>&sabun=<%=sabun%>" noresize bordercolor="#000000" > 
</frameset>
<noframes> 
