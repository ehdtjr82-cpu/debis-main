                        ...
                        <TD align="center" bgcolor="#FFFFFF">
                        	<TABLE width="95%"  border="0" cellspacing="0" cellpadding="2">
                              ...
                              <TR>
                                ...
                                <TD valign="bottom"><A style="COLOR: red" href="http://ebiz.debis.co.kr/ep/download/debis_setup_guide.doc" target=_blank download="데비스 설치 가이드.doc"><IMG src="<%= ls_img_package %>/Content_help.gif" width="57" height="18"></A></TD>
                              </TR>
                          </TABLE>
                        </TD>
                      </TR>
...
<!-- ActiveUpdate 컴포넌트 정의  XMLUrl을 사용하는 경우 BODY TAG 내부에 기술이 되어 있어야 합니다. -->
	<OBJECT ID="Manager" CLASSID="CLSID:7A868592-7D06-44CF-ADF1-EF7517BD8F3A" codebase="/cabfiles/ManagerEx4.cab#version=4,0,3,13">
