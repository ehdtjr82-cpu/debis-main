...
<%!
/** 
* @source  : $Source: /DBL_PROJECT/DBL_PROJECT/DBL_EAR/WEB_ROOT/common/jsp/in_login.jsp,v $
* @date    : $Date: 2008/08/20 06:59:43 $
...
location.href = "/to/in/bulk/tmlbulk/in_202_04_02b.jsp";
</script>
<% 
  } else { 
%> 
...
<table width="230" height="299"  border="1" cellspacing="0" cellpadding="0" >
  <tr> 
    <td align="center" valign="top">
      <!-- 타이틀영역 -->
      <table width="100%"  height="10%" border="0" cellpadding="0" cellspacing="0" bgcolor="003366">
        <tr>
          <td><img src="/common/images/Content_titlearrow.gif" align="absmiddle">&nbsp;
          	<span class="title_default">동부인천항만(주) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
        ...
        <tr>
          <td  height="40%" background="/common/images/title_back_line01.gif"></td>
        </tr>
      </table>
      <!-- 타이틀영역 end -->
      <!-- 데이타영역 -->
        ...
        <tr> 
 	    ...
 	    <tr>
		   <td height="10%" align="center">
				아  이  디&nbsp;&nbsp; <input TYPE="text" class=input_text id="txt_userId" size="10">
		   </td> 	
	   </tr>	         
 	    <tr>
		   <td height="10%" align="center">
				비밀번호&nbsp; <input TYPE="text" class=input_text id="txt_passwd" size="10">
		   </td> 	
	   </tr>
 	    <tr>
		   <td height="30%" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		   <a href="javascript:jsLogin();"><img tabIndex="-1" src="/common/images/login_bt.gif" width="62" height="47" border="0"></a>
		   </td> 	
	   </tr>	  	   	   
 	  </table>
