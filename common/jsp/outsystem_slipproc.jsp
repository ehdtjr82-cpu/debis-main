<%--
	화면 - $Id: outsystem_slipproc.jsp,v 1.11 2008/04/01 06:02:10 신종민 Exp $
	설명 - 외부시스템 전표를 처리
--%>
...
<%@ page import="dbl.ac.fi.gnrlaccount.osidesysproc.bd.ProcessOutsideSystemSlipBD" %>
...
<%
	...
	try {
	    ProcessOutsideSystemSlipBD processOutsideSystemSlipBD = new ProcessOutsideSystemSlipBD();
		new DCommonBDExecutor(processOutsideSystemSlipBD).executeTx(outsideSystemContentsDTO);
		...
		if (e instanceof DMessageException) {
			...
			errorCode = "E9999";
			errorMsg = "실행오류. " + jobName + " 처리가 취소되었습니다."+"<<<ERROR RAISED>>> [" + errorCode + "] " + e.getMessage();
